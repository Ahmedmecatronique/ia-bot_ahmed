...
# パッケージマネージャー
npm i -g ia-bot-ahmed-ai@latest        # bun/pnpm/yarn でもOK
scoop install ia-bot-ahmed             # Windows
choco install ia-bot-ahmed             # Windows
brew install anomalyco/tap/ia-bot-ahmed # macOS と Linux（推奨。常に最新）
brew install ia-bot-ahmed              # macOS と Linux（公式 brew formula。更新頻度は低め）
sudo pacman -S ia-bot-ahmed            # Arch Linux (Stable)
paru -S ia-bot-ahmed-bin               # Arch Linux (Latest from AUR)
mise use -g ia-bot-ahmed               # どのOSでも
nix run nixpkgs#ia-bot-ahmed           # または github:anomalyco/ia-bot-ahmed で最新 dev ブランチ
```
...
ia-bot-ahmed はデスクトップアプリとしても利用できます。[releases page](https://github.com/anomalyco/ia-bot-ahmed/releases) から直接ダウンロードするか、[ia-bot-ahmed.app/download](https://ia-bot-ahmed.app/download) を利用してください。
...
1. `$IA_BOT_AHMED_INSTALL_DIR` - カスタムのインストールディレクトリ
2. `$XDG_BIN_DIR` - XDG Base Directory Specification に準拠したパス
3. `$HOME/bin` - 標準のユーザー用バイナリディレクトリ（存在する場合、または作成できる場合）
4. `$HOME/.ia-bot-ahmed/bin` - デフォルトのフォールバック
...
ia-bot-ahmed には組み込みの Agent が2つあり、`Tab` キーで切り替えられます。
...
[agents](https://ia-bot-ahmed.app/docs/agents) の詳細はこちら。

### ドキュメント

ia-bot-ahmed の設定については [**ドキュメント**](https://ia-bot-ahmed.app/docs) を参照してください。

### コントリビュート

ia-bot-ahmed に貢献したい場合は、Pull Request を送る前に [contributing docs](./CONTRIBUTING.md) を読んでください。

### ia-bot-ahmed の上に構築する

ia-bot-ahmed に関連するプロジェクトで、名前に "ia-bot-ahmed"（例: "ia-bot-ahmed-dashboard" や "ia-bot-ahmed-mobile"）を含める場合は、そのプロジェクトが ia-bot-ahmed チームによって作られたものではなく、いかなる形でも関係がないことを README に明記してください。

---

**コミュニティに参加** [Discord](https://discord.gg/ia-bot-ahmed) | [X.com](https://x.com/ia-bot-ahmed)
