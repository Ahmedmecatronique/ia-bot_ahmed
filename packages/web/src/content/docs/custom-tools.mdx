---
title: Custom Tools
description: Create tools the LLM can call in ia-bot-ahmed.
---

Custom tools are functions you create that the LLM can call during conversations. They work alongside ia-bot-ahmed's [built-in tools](/docs/tools) like `read`, `write`, and `bash`.
...
- Locally by placing them in the `.ia-bot-ahmed/tools/` directory of your project.
- Or globally, by placing them in `~/.config/ia-bot-ahmed/tools/`.
