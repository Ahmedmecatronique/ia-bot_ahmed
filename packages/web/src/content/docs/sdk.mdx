---
title: SDK
description: Type-safe JS client for ia-bot-ahmed server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The ia-bot-ahmed JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control ia-bot-ahmed programmatically.
...
Create an instance of ia-bot-ahmed:
...
You can pass a configuration object to customize behavior. The instance still picks up your `ia-bot-ahmed.json`, but you can override or add configuration inline:
...
If you already have a running instance of ia-bot-ahmed, you can create a client instance to connect to it:
