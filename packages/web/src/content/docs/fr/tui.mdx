---
title: TUI
description: Utilisation de l’interface utilisateur du terminal ia-bot-ahmed.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

ia-bot-ahmed fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de ia-bot-ahmed démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le ia-bot-ahmed TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à ia-bot-ahmed. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Quittez ia-bot-ahmed. *Alias* : `/quit`, `/q`
...
Ceci est séparé de `ia-bot-ahmed.json`, qui configure le comportement du serveur/d'exécution.
...
- `leader_timeout` - Contrôle la durée pendant laquelle ia-bot-ahmed attend après la leader key. Valeur par défaut : `2000`.
...
- `sound_pack` - ID du sound pack à utiliser. Valeur par défaut : `ia-bot-ahmed.default`.
