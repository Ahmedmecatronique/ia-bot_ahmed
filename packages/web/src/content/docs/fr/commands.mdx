...
Créez `.ia-bot-ahmed/commands/test.md` :
...
Vous pouvez ajouter des commandes personnalisées via la configuration ia-bot-ahmed ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre ia-bot-ahmed [config](/docs/config) :
...
- Par projet : `.ia-bot-ahmed/commands/`
...
ia-bot-ahmed comprend plusieurs commandes intégrées comme `/init`, `/undo`, `/redo`, `/share`, `/help` ; [en savoir plus](/docs/tui#commands).
