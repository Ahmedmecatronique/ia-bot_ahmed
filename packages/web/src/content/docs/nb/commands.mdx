...
Opprett `.ia-bot-ahmed/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom ia-bot-ahmed-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i ia-bot-ahmed [config](/docs/config):
...
- Per prosjekt: `.ia-bot-ahmed/commands/`
...
ia-bot-ahmed inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
