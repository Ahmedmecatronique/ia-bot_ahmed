...
Det er to typer agenter i ia-bot-ahmed; primære agenter og underagenter.
...
ia-bot-ahmed kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
ia-bot-ahmed kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

ia-bot-ahmed kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Konfigurer agenter i konfigurasjonsfilen `ia-bot-ahmed.json`:
...
- Per prosjekt: `.ia-bot-ahmed/agents/`
...
Hvis ingen temperatur er spesifisert, bruker ia-bot-ahmed modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale ia-bot-ahmed-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i ia-bot-ahmed-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [ia-bot-ahmed Zen](/docs/zen), vil du bruke `ia-bot-ahmed/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `ia-bot-ahmed models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/anomalyco/ia-bot-ahmed).
:::
