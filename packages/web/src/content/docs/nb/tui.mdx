---
title: TUI
description: Bruke ia-bot-ahmed-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

ia-bot-ahmed gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre ia-bot-ahmed starter TUI for gjeldende katalog.
...
Når du bruker ia-bot-ahmed TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til ia-bot-ahmed. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt ia-bot-ahmed. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `ia-bot-ahmed.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge ia-bot-ahmed venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `ia-bot-ahmed.default`.
