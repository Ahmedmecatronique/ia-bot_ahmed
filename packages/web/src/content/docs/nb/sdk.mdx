---
title: SDK
description: Typesikker JS-klient for ia-bot-ahmed-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

ia-bot-ahmed JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere ia-bot-ahmed programmatisk.
...
Opprett en forekomst av ia-bot-ahmed:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `ia-bot-ahmed.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av ia-bot-ahmed, kan du opprette en klientforekomst for å koble til den:
