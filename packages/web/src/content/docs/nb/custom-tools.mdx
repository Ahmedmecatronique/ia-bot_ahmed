...
description: Lag verktøy som LLM kan kalle inn ia-bot-ahmed.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med ia-bot-ahmed sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.ia-bot-ahmed/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/ia-bot-ahmed/tools/`.
