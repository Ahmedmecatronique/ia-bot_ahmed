...
ia-bot-ahmed Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i ia-bot-ahmed. Du abonnerer på ia-bot-ahmed Go og
...
ia-bot-ahmed Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

ia-bot-ahmed Go fungerer som enhver annen leverandør i ia-bot-ahmed.

1. Du logger inn på **<a href={console}>ia-bot-ahmed Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `ia-bot-ahmed Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på ia-bot-ahmed Go.
:::
...
ia-bot-ahmed Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din ia-bot-ahmed-konfigurasjon
bruker formatet `ia-bot-ahmed-go/<model-id>`. For eksempel, for Kimi K2.7 Code, vil du
bruke `ia-bot-ahmed-go/kimi-k2.7-code` i konfigurasjonen din.
...
Vi opprettet ia-bot-ahmed Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med ia-bot-ahmed også.
