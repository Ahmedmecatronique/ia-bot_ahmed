---
title: Condivisione
description: Condividi le tue conversazioni ia-bot-ahmed.
---

La funzione di condivisione di ia-bot-ahmed ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, ia-bot-ahmed:
...
ia-bot-ahmed supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, ia-bot-ahmed usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `ia-bot-ahmed.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare ia-bot-ahmed nella tua organizzazione.
