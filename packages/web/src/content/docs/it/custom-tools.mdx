...
description: Crea strumenti che l'LLM puo chiamare in ia-bot-ahmed.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di ia-bot-ahmed come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.ia-bot-ahmed/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/ia-bot-ahmed/tools/`.
