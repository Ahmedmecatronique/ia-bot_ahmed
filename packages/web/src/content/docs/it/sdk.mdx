---
title: SDK
description: Client JS type-safe per il server ia-bot-ahmed.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

L'SDK JS/TS di ia-bot-ahmed fornisce un client type-safe per interagire con il server.
Usalo per creare integrazioni e controllare ia-bot-ahmed in modo programmatico.
...
Crea un'istanza di ia-bot-ahmed:
...
Puoi passare un oggetto di configurazione per personalizzare il comportamento. L'istanza legge comunque `ia-bot-ahmed.json`, ma puoi sovrascrivere o aggiungere configurazione inline:
...
Se hai gia un'istanza di ia-bot-ahmed in esecuzione, puoi creare un client per collegarti:
