...
Le skill degli agenti permettono a ia-bot-ahmed di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
ia-bot-ahmed cerca in queste posizioni:

- Config di progetto: `.ia-bot-ahmed/skills/<name>/SKILL.md`
- Config globale: `~/.config/ia-bot-ahmed/skills/<name>/SKILL.md`
...
Per i percorsi locali al progetto, ia-bot-ahmed risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
Carica qualsiasi `skills/*/SKILL.md` corrispondente in `.ia-bot-ahmed/` e qualsiasi `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` corrispondente lungo il percorso.

Le definizioni globali vengono caricate anche da `~/.config/ia-bot-ahmed/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` e `~/.agents/skills/*/SKILL.md`.
...
Crea `.ia-bot-ahmed/skills/git-release/SKILL.md` cosi':
...
ia-bot-ahmed elenca le skill disponibili nella descrizione dello strumento `skill`.
...
Controlla a quali skill gli agenti possono accedere usando permessi basati su pattern in `ia-bot-ahmed.json`:
...
**Per agenti integrati** (in `ia-bot-ahmed.json`):
