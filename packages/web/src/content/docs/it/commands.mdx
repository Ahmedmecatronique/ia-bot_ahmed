...
Crea `.ia-bot-ahmed/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di ia-bot-ahmed o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di ia-bot-ahmed:
...
- Globale: `~/.config/ia-bot-ahmed/commands/`
- Per progetto: `.ia-bot-ahmed/commands/`
...
ia-bot-ahmed include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
