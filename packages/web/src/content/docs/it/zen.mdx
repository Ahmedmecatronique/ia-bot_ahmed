---
title: Zen
description: Lista curata di modelli fornita da ia-bot-ahmed.
---
...
ia-bot-ahmed Zen è un elenco di modelli testati e verificati forniti dal team di ia-bot-ahmed.

Zen funziona come qualsiasi altro provider in ia-bot-ahmed. Accedi a ia-bot-ahmed Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con ia-bot-ahmed.
:::
...
ia-bot-ahmed Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

ia-bot-ahmed Zen funziona come qualsiasi altro provider in ia-bot-ahmed.

1. Accedi a **<a href={console}>ia-bot-ahmed Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona ia-bot-ahmed Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di ia-bot-ahmed
usa il formato `ia-bot-ahmed/<model-id>`. Per esempio, per GPT 5.5, useresti
`ia-bot-ahmed/gpt-5.5` nella tua config.
...
- DeepSeek V4 Flash Free è disponibile su ia-bot-ahmed per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su ia-bot-ahmed per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- North Mini Code Free è disponibile su ia-bot-ahmed per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su ia-bot-ahmed per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su ia-bot-ahmed per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato ia-bot-ahmed Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con ia-bot-ahmed.
