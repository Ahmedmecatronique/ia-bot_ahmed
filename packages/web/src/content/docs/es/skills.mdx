...
Las habilidades del agente permiten a ia-bot-ahmed descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
ia-bot-ahmed busca estas ubicaciones:

- Configuración del proyecto: `.ia-bot-ahmed/skills/<name>/SKILL.md`
- Configuración global: `~/.config/ia-bot-ahmed/skills/<name>/SKILL.md`
...
Para las rutas locales del proyecto, ia-bot-ahmed sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
Carga cualquier `skills/*/SKILL.md` coincidente en `.ia-bot-ahmed/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/ia-bot-ahmed/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.ia-bot-ahmed/skills/git-release/SKILL.md` así:
...
ia-bot-ahmed enumera las habilidades disponibles en la descripción de la herramienta `skill`.
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `ia-bot-ahmed.json`:
...
**Para agentes integrados** (en `ia-bot-ahmed.json`):
