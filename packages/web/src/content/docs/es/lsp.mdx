...
description: ia-bot-ahmed se integra con sus servidores LSP.
---

ia-bot-ahmed puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

ia-bot-ahmed viene con varios servidores LSP integrados para idiomas populares:
...
:::note
Puede deshabilitar las descargas automáticas del servidor LSP configurando la variable de entorno `IA_BOT_AHMED_DISABLE_LSP_DOWNLOAD` en `true`.
:::
...
Cuando LSP está habilitado y ia-bot-ahmed abre un archivo:
...
Puede habilitar y personalizar los servidores LSP a través de la sección `lsp` en su configuración ia-bot-ahmed.
