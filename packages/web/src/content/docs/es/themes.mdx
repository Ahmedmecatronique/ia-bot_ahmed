...
Con ia-bot-ahmed puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, ia-bot-ahmed usa nuestro propio tema `ia-bot-ahmed`.
...
ia-bot-ahmed viene con varios temas integrados.
...
- Quiere que ia-bot-ahmed coincida con la apariencia de su terminal
...
ia-bot-ahmed admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/ia-bot-ahmed/themes/*.json` o `$XDG_CONFIG_HOME/ia-bot-ahmed/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.ia-bot-ahmed/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.ia-bot-ahmed/themes/*.json`
