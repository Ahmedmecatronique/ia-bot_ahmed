---
title: Servidor
description: Interactuar con el servidor ia-bot-ahmed a través de HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El comando `ia-bot-ahmed serve` ejecuta un servidor HTTP sin cabeza que expone un punto final OpenAPI que un cliente ia-bot-ahmed puede usar.
...
| `--mdns-domain` | Nombre de dominio personalizado para el servicio mDNS | `ia-bot-ahmed.local` |
...
Configure `IA_BOT_AHMED_SERVER_PASSWORD` para proteger el servidor con autenticación básica HTTP. El nombre de usuario predeterminado es `ia-bot-ahmed`, o configure `IA_BOT_AHMED_SERVER_USERNAME` para anularlo. Esto se aplica tanto a `ia-bot-ahmed serve` como a `ia-bot-ahmed web`.
...
Cuando ejecuta `ia-bot-ahmed`, inicia un TUI y un servidor. Donde el TUI es el
...
:::tip
Utilice el servidor ia-bot-ahmed para interactuar con ia-bot-ahmed mediante programación.
:::

Esta arquitectura permite que ia-bot-ahmed admita múltiples clientes y le permite interactuar con ia-bot-ahmed mediante programación.

Puede ejecutar `ia-bot-ahmed serve` para iniciar un servidor independiente. Si tienes el
ia-bot-ahmed TUI ejecutándose, `ia-bot-ahmed serve` iniciará un nuevo servidor.
...
El punto final [`/tui`](#tui) se puede utilizar para conducir el TUI a través del servidor. Por ejemplo, puede completar previamente o ejecutar un mensaje. Esta configuración es utilizada por los complementos ia-bot-ahmed [IDE](/docs/ide).
...
El servidor ia-bot-ahmed expone las siguientes API.
