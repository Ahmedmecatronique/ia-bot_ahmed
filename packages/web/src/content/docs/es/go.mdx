...
ia-bot-ahmed Go es una suscripción de bajo costo — **$5 por tu primer mes**, luego **$10/mes** — que te brinda acceso confiable a modelos abiertos de programación populares.

Go funciona como cualquier otro proveedor en ia-bot-ahmed. Te suscribes a ia-bot-ahmed Go y
...
ia-bot-ahmed Go te da acceso a estos modelos por **$5 por tu primer mes**, luego **$10/mes**.

---

## Cómo funciona

ia-bot-ahmed Go funciona como cualquier otro proveedor en ia-bot-ahmed.

1. Inicias sesión en **<a href={console}>ia-bot-ahmed Zen</a>**, te suscribes a Go y
   copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas `ia-bot-ahmed Go` y pegas
   tu API key.
3. Ejecutas `/models` en la TUI para ver la lista de modelos disponibles a través de Go.

:::note
Solo un miembro por espacio de trabajo puede suscribirse a ia-bot-ahmed Go.
:::
...
ia-bot-ahmed Go incluye los siguientes límites:
...
El [ID del modelo](/docs/config/#models) en tu configuración de ia-bot-ahmed
usa el formato `ia-bot-ahmed-go/<model-id>`. Por ejemplo, para Kimi K2.7 Code, usarías
`ia-bot-ahmed-go/kimi-k2.7-code` en tu configuración.
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con ia-bot-ahmed.
