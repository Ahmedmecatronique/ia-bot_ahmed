---
title: TUI
description: Usando la interfaz de usuario del terminal ia-bot-ahmed.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

ia-bot-ahmed proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar ia-bot-ahmed se inicia TUI para el directorio actual.
...
Cuando utilice ia-bot-ahmed TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a ia-bot-ahmed. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de ia-bot-ahmed. _Alias_: `/quit`, `/q`
...
Esto es independiente de `ia-bot-ahmed.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera ia-bot-ahmed después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `ia-bot-ahmed.default`.
