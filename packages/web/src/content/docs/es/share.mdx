---
title: Compartir
description: Comparte tus conversaciones ia-bot-ahmed.
---

La función para compartir de ia-bot-ahmed te permite crear enlaces públicos a tus conversaciones de ia-bot-ahmed, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, ia-bot-ahmed:
...
ia-bot-ahmed admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, ia-bot-ahmed usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `ia-bot-ahmed.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de ia-bot-ahmed en su organización.
