...
Crear `.ia-bot-ahmed/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración ia-bot-ahmed o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su ia-bot-ahmed [config](/docs/config):
...
- Por proyecto: `.ia-bot-ahmed/commands/`
...
ia-bot-ahmed incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
