---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor ia-bot-ahmed.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El SDK ia-bot-ahmed JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar ia-bot-ahmed mediante programación.
...
Cree una instancia de ia-bot-ahmed:
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `ia-bot-ahmed.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de ia-bot-ahmed, puede crear una instancia de cliente para conectarse a ella:
