...
สร้าง `.ia-bot-ahmed/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ ia-bot-ahmed:
...
- ระดับผู้ใช้ (Global): `~/.config/ia-bot-ahmed/commands/`
- ระดับโปรเจ็กต์: `.ia-bot-ahmed/commands/`
...
ia-bot-ahmed มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
