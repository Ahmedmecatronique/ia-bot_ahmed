...
Med ia-bot-ahmed kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger ia-bot-ahmed vårt eget `ia-bot-ahmed`-tema.
...
ia-bot-ahmed kommer med flere innebygde temaer.
...
- Vil at ia-bot-ahmed skal matche terminalens utseende
...
ia-bot-ahmed støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
...
2. **Brugerkonfigurasjonskatalog** - Definert i `~/.config/ia-bot-ahmed/themes/*.json` eller `$XDG_CONFIG_HOME/ia-bot-ahmed/themes/*.json`
3. **Prosjektrotkatalog** - Definert i `<project-root>/.ia-bot-ahmed/themes/*.json`
4. **Nuværende arbejdskatalog** - Definert i `./.ia-bot-ahmed/themes/*.json`
