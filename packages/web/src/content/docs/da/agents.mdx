...
Der er to typer agenter i ia-bot-ahmed; primære agenter og subagenter.
...
ia-bot-ahmed leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
ia-bot-ahmed leveres med tre indbyggede subagenter, **General**, **Explore** og **Scout**. Vi ser nærmere på dem nedenfor.

---

## Indbyggede

ia-bot-ahmed leveres med to indbyggede primære agenter og tre indbyggede subagenter.
...
En skrivebeskyttet agent til eksterne docs og research af dependencies. Brug denne, når du har brug for at klone et dependency-repository ind i ia-bot-ahmed's administrerede cache, inspicere kildekoden i et bibliotek eller krydstjekke lokal kode mod upstream-implementeringer uden at ændre dit workspace.
...
Konfigurer agent i din `ia-bot-ahmed.json`-konfigurationsfil:
...
- Globalt: `~/.config/ia-bot-ahmed/agents/`
- Pr. projekt: `.ia-bot-ahmed/agents/`
...
Hvis ingen temperatur er angivet, bruger ia-bot-ahmed modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale ia-bot-ahmed-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din ia-bot-ahmed-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [ia-bot-ahmed Zen](/docs/zen), vil du bruge `ia-bot-ahmed/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `ia-bot-ahmed models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/anomalyco/ia-bot-ahmed).
:::
