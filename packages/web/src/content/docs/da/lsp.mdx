---
title: LSP-servere
description: ia-bot-ahmed integreres med dine LSP-servere.
---

ia-bot-ahmed kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

ia-bot-ahmed leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `IA_BOT_AHMED_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og ia-bot-ahmed åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din ia-bot-ahmed-konfiguration.
