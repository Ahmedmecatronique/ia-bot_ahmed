---
title: Deling
description: Del dine ia-bot-ahmed-samtaler.
---

ia-bot-ahmeds delingsfunksjon lar deg lage offentlige lenker til dine ia-bot-ahmed-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, ia-bot-ahmed:
...
ia-bot-ahmed støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger ia-bot-ahmed manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `ia-bot-ahmed.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av ia-bot-ahmed i organisasjonen din.
