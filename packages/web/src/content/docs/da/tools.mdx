...
Her er alle de innebygde verktøyene som er tilgængelige i ia-bot-ahmed.
...
:::note
Dette verktøyet er bare tilgængelig når `IA_BOT_AHMED_EXPERIMENTAL_LSP_TOOL=true` (eller `IA_BOT_AHMED_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger ia-bot-ahmed-leverandøren eller når miljøvariabelen `IA_BOT_AHMED_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
