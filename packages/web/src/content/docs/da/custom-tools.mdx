...
description: Opret værktøjer, som LLM kan kalde ia-bot-ahmed ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med ia-bot-ahmeds [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.ia-bot-ahmed/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/ia-bot-ahmed/tools/`.
