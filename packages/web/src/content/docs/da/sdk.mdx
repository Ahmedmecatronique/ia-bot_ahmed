...
Brug den til at bygge integrasjoner og kontrollere ia-bot-ahmed programmatisk.
...
Opret en forekomst av ia-bot-ahmed:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `ia-bot-ahmed.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av ia-bot-ahmed, kan du oprete en klientforekomst for at koble til den:
