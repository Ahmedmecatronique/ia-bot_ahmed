---
title: Server
description: Interager med ia-bot-ahmed-serveren over HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Kommandoen `ia-bot-ahmed serve` kører en hovedløs HTTP-server, som afslører et OpenAPI-endpoint, som en ia-bot-ahmed-klient kan bruge.
...
| `--mdns-domain` | Brugerdefineret domænenavn for mDNS-tjeneste | `ia-bot-ahmed.local` |
...
Indstil `IA_BOT_AHMED_SERVER_PASSWORD` for at beskytte serveren med HTTP grundlæggende godkendelse. Brugernavnet er som standard `ia-bot-ahmed`, eller indstil `IA_BOT_AHMED_SERVER_USERNAME` for at tilsidesætte det. Dette gælder både `ia-bot-ahmed serve` og `ia-bot-ahmed web`.
...
Når du kører `ia-bot-ahmed` starter den en TUI og en server. Hvor TUI er
...
:::tip
Brug ia-bot-ahmed-serveren til at interagere med ia-bot-ahmed programmatisk.
:::

Denne arkitektur lader ia-bot-ahmed understøtte flere klienter og lader dig interagere med ia-bot-ahmed programmatisk.

Du kan køre `ia-bot-ahmed serve` for at starte en selvstændig server. Hvis du har
ia-bot-ahmed TUI kørende, vil `ia-bot-ahmed serve` starte en ny server.
...
[`/tui`](#tui) endpointet kan bruges til at køre TUI gennem serveren. Du kan for eksempel forududfylde eller køre en forespørgsel. Denne opsætning bruges af ia-bot-ahmed [IDE](/docs/ide) plugins.
...
ia-bot-ahmed-serveren viser følgende API'er.
