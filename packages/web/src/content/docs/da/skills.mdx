...
Agentferdigheter lar ia-bot-ahmed oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
ia-bot-ahmed søker etter disse stedene:

- Prosjektkonfigurasjon: `.ia-bot-ahmed/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/ia-bot-ahmed/skills/<name>/SKILL.md`
...
For prosjektlokale stier går ia-bot-ahmed opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.ia-bot-ahmed/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/ia-bot-ahmed/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.ia-bot-ahmed/skills/git-release/SKILL.md` slik:
...
ia-bot-ahmed viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `ia-bot-ahmed.json`:
...
**For innebygde agenter** (i `ia-bot-ahmed.json`):
