---
title: Dijeljenje
description: Dijelite ia-bot-ahmed razgovore javnim linkovima.
---

ia-bot-ahmed opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, ia-bot-ahmed:
...
ia-bot-ahmed podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, ia-bot-ahmed koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `ia-bot-ahmed.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju ia-bot-ahmed u organizaciji.
