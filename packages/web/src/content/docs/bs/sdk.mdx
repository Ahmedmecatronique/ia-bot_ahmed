---
title: SDK
description: Type-safe JS klijent za ia-bot-ahmed server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

ia-bot-ahmed JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
Koristite ga za izradu integracija i programsko upravljanje ia-bot-ahmed-om.
...
Kreirajte instancu ia-bot-ahmed:
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `ia-bot-ahmed.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu ia-bot-ahmed instancu, mozete napraviti klijentsku instancu i povezati se na nju:
