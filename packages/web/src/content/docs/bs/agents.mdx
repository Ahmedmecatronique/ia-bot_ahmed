...
Postoje dvije vrste agenata u ia-bot-ahmed: primarni agenti i podagenti.
...
ia-bot-ahmed dolazi sa dva ugrađena primarna agenta, **Build** i **Plan**. Pogledat ćemo ih u nastavku.
...
ia-bot-ahmed dolazi sa tri ugrađena subagenta, **General**, **Explore** i **Scout**. Ovo ćemo pogledati u nastavku.

---

## Ugrađeni

ia-bot-ahmed dolazi sa dva ugrađena primarna agenta i tri ugrađena subagenta.
...
Agent samo za čitanje za istraživanje eksterne dokumentacije i zavisnosti. Koristite ga kada trebate klonirati repozitorij zavisnosti u ia-bot-ahmed-ov upravljani cache, pregledati izvorni kod biblioteke ili uporediti lokalni kod sa upstream implementacijama bez mijenjanja vašeg radnog prostora.
...
Konfigurirajte agente u svom konfiguracijskom fajlu `ia-bot-ahmed.json`:
...
- Globalno: `~/.config/ia-bot-ahmed/agents/`
- Po projektu: `.ia-bot-ahmed/agents/`
...
Ako temperatura nije navedena, ia-bot-ahmed koristi standardne postavke specifične za model; obično 0 za većinu modela, 0.55 za Qwen modele.
...
Ova putanja je relativna u odnosu na mjesto gdje se nalazi konfiguracijski fajl. Dakle, ovo radi i za globalnu ia-bot-ahmed konfiguraciju i za konfiguraciju specifične za projekat.
...
ID modela u vašoj ia-bot-ahmed konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite [ia-bot-ahmed Zen](/docs/zen), koristili biste `ia-bot-ahmed/gpt-5.1-codex` za GPT 5.1 Codex.
...
:::tip
Pokrenite `ia-bot-ahmed models` da vidite listu dostupnih modela.
:::
...
:::tip
Imate li agenta kojeg biste željeli podijeliti? [Pošalji PR](https://github.com/anomalyco/ia-bot-ahmed).
:::
