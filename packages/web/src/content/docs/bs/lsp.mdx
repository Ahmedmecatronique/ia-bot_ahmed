---
title: LSP serveri
description: ia-bot-ahmed se integriše sa vašim LSP serverima.
---

ia-bot-ahmed se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

ia-bot-ahmed dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `IA_BOT_AHMED_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i ia-bot-ahmed otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj ia-bot-ahmed konfiguraciji.
