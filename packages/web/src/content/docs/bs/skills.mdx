...
Agent skills omogucavaju ia-bot-ahmed da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
ia-bot-ahmed pretrazuje ove lokacije:

- Konfiguracija projekta: `.ia-bot-ahmed/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/ia-bot-ahmed/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, ia-bot-ahmed ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.ia-bot-ahmed/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/ia-bot-ahmed/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.ia-bot-ahmed/skills/git-release/SKILL.md` ovako:
...
ia-bot-ahmed navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `ia-bot-ahmed.json`:
...
**Za ugradene agente** (u `ia-bot-ahmed.json`):
