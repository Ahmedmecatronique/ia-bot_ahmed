...
Kreiraj `.ia-bot-ahmed/commands/test.md`:
...
Možete dodati prilagođene komande kroz ia-bot-ahmed konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom ia-bot-ahmed [config](/docs/config):
...
- Globalno: `~/.config/ia-bot-ahmed/commands/`
- Po projektu: `.ia-bot-ahmed/commands/`
...
ia-bot-ahmed uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
