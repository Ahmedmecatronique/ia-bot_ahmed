...
أنشئ الملف `.ia-bot-ahmed/commands/test.md`:
...
يمكنك إضافة أوامر مخصصة عبر إعدادات ia-bot-ahmed أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ ia-bot-ahmed:
...
- على مستوى النظام: `~/.config/ia-bot-ahmed/commands/`
- لكل مشروع: `.ia-bot-ahmed/commands/`
...
يتضمن ia-bot-ahmed عدة أوامر مضمنة مثل `/init` و`/undo` و`/redo` و`/share` و`/help`؛ [اعرف المزيد](/docs/tui#commands).
