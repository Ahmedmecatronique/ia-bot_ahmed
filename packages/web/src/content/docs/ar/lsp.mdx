---
title: خوادم LSP
description: يتكامل ia-bot-ahmed مع خوادم LSP لديك.
---

يمكن أن يتكامل ia-bot-ahmed مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي ia-bot-ahmed مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `IA_BOT_AHMED_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عند تفعيل LSP وفتح ia-bot-ahmed لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات ia-bot-ahmed.
