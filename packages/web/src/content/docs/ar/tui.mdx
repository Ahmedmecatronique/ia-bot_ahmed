---
title: TUI
description: استخدام واجهة المستخدم TUI في ia-bot-ahmed.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر ia-bot-ahmed واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل ia-bot-ahmed إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة ia-bot-ahmed في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى ia-bot-ahmed. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من ia-bot-ahmed. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `ia-bot-ahmed.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار ia-bot-ahmed بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `ia-bot-ahmed.default`.
