...
مع ia-bot-ahmed يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم ia-bot-ahmed سمتنا `ia-bot-ahmed`.
...
يأتي ia-bot-ahmed مع عدة سمات مدمجة.
...
- يريدون أن يطابق ia-bot-ahmed مظهر terminal لديهم
...
يدعم ia-bot-ahmed نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
2. **مجلد ضبط المستخدم** - معرّف في `~/.config/ia-bot-ahmed/themes/*.json` أو `$XDG_CONFIG_HOME/ia-bot-ahmed/themes/*.json`
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.ia-bot-ahmed/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.ia-bot-ahmed/themes/*.json`
