...
description: ia-bot-ahmed, LSP sunucularınızla bütünleşir.
---

ia-bot-ahmed, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

ia-bot-ahmed, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
:::note
`IA_BOT_AHMED_DISABLE_LSP_DOWNLOAD` ortam değişkenini `true` olarak ayarlayarak otomatik LSP sunucu indirmelerini devre dışı bırakabilirsiniz.
:::
...
LSP etkinleştirildiğinde ve ia-bot-ahmed bir dosyayı açtığında:
...
LSP sunucularını, ia-bot-ahmed yapılandırmanızdaki `lsp` bölümü aracılığıyla etkinleştirebilir ve özelleştirebilirsiniz.
