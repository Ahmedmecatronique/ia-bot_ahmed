...
`.ia-bot-ahmed/commands/test.md` oluştur:
...
ia-bot-ahmed işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

ia-bot-ahmed [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/ia-bot-ahmed/commands/`
- Proje başına: `.ia-bot-ahmed/commands/`
...
ia-bot-ahmed, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
