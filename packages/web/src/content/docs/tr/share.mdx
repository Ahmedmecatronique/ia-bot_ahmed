---
title: Paylasim
description: ia-bot-ahmed konusmalarini genel baglantilarla paylasin.
---

ia-bot-ahmed'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda ia-bot-ahmed:
...
ia-bot-ahmed, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak ia-bot-ahmed manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `ia-bot-ahmed.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda ia-bot-ahmed kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
