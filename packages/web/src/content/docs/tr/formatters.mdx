...
description: ia-bot-ahmed dile özgü biçimlendiriciler kullanır.
---

ia-bot-ahmed, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

ia-bot-ahmed, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, ia-bot-ahmed bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

ia-bot-ahmed bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri ia-bot-ahmed yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
