...
Ajan becerileri, ia-bot-ahmed'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
ia-bot-ahmed su konumlari tarar:

- Proje konfigurasyonu: `.ia-bot-ahmed/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/ia-bot-ahmed/skills/<name>/SKILL.md`
...
Proje yerel yollarinda ia-bot-ahmed, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.ia-bot-ahmed/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/ia-bot-ahmed/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.ia-bot-ahmed/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
ia-bot-ahmed, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`ia-bot-ahmed.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`ia-bot-ahmed.json` icinde):
