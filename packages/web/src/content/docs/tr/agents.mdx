...
ia-bot-ahmed'da iki tür agent vardır; birincil agent'lar ve alt agent'lar.
...
ia-bot-ahmed, **Build** ve **Plan** olmak üzere iki yerleşik birincil agent ile birlikte gelir. Bunlara aşağıda bakacağız.
...
ia-bot-ahmed, **General**, **Explore** ve **Scout** olmak üzere üç yerleşik alt agent ile birlikte gelir. Buna aşağıda bakacağız.

---

## Yerleşik

ia-bot-ahmed iki yerleşik birincil agent ve üç yerleşik alt agent ile birlikte gelir.
...
Agent'ları `ia-bot-ahmed.json` yapılandırma dosyanızda yapılandırın:
...
- Proje başına: `.ia-bot-ahmed/agents/`
...
Sıcaklık belirtilmezse ia-bot-ahmed modeline özgü varsayılanları kullanır; çoğu model için genellikle 0, Qwen modelleri için 0,55.
...
Bu yol, yapılandırma dosyasının bulunduğu yere göredir. Yani bu hem global ia-bot-ahmed yapılandırması hem de projeye özel yapılandırma için işe yarar.
...
ia-bot-ahmed yapılandırmanızdaki model kimliği `provider/model-id` biçimini kullanır. Örneğin, [ia-bot-ahmed Zen](/docs/zen) kullanıyorsanız, GPT 5.1 Codex için `ia-bot-ahmed/gpt-5.1-codex` kullanırsınız.
...
:::tip
Mevcut modellerin listesini görmek için `ia-bot-ahmed models` komutunu çalıştırın.
:::
...
:::tip
Paylaşmak istediğiniz bir agent'ınız var mı? [Submit a PR](https://github.com/anomalyco/ia-bot-ahmed).
:::
