---
title: SDK
description: ia-bot-ahmed sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

ia-bot-ahmed JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
ia-bot-ahmed'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir ia-bot-ahmed örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `ia-bot-ahmed.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir ia-bot-ahmed örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
