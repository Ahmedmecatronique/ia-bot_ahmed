---
title: Özel Araçlar
description: LLM'un ia-bot-ahmed'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. ia-bot-ahmed'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.ia-bot-ahmed/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/ia-bot-ahmed/tools/` içine yerleştirerek.
