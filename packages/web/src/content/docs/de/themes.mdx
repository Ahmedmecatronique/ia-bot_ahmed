...
Mit ia-bot-ahmed kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet ia-bot-ahmed das `ia-bot-ahmed`-Theme.
...
ia-bot-ahmed liefert mehrere eingebaute Themes mit.
...
- ia-bot-ahmed optisch ans Terminal anpassen wollen
...
ia-bot-ahmed unterstuetzt ein flexibles JSON-basiertes Theme-System.
...
2. **Benutzer-Config-Verzeichnis** - Definiert in `~/.config/ia-bot-ahmed/themes/*.json` oder `$XDG_CONFIG_HOME/ia-bot-ahmed/themes/*.json`
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.ia-bot-ahmed/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.ia-bot-ahmed/themes/*.json`
