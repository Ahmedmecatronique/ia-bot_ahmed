...
Erstellen Sie `.ia-bot-ahmed/commands/test.md`:

```md title=".ia-bot-ahmed/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die ia-bot-ahmed-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem ia-bot-ahmed [config](/docs/config):

```json title="ia-bot-ahmed.jsonc" {4-12}
{
...
- Global: `~/.config/ia-bot-ahmed/commands/`
- Pro Projekt: `.ia-bot-ahmed/commands/`

```markdown title="~/.config/ia-bot-ahmed/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".ia-bot-ahmed/commands/component.md"
---
...
```md title=".ia-bot-ahmed/commands/create-file.md"
---
...
```md title=".ia-bot-ahmed/commands/analyze-coverage.md"
---
...
```md title=".ia-bot-ahmed/commands/review-changes.md"
---
...
```md title=".ia-bot-ahmed/commands/review-component.md"
---
...
ia-bot-ahmed enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
