---
title: LSP Server
description: ia-bot-ahmed lässt sich in Ihren LSP-Server integrieren.
---

ia-bot-ahmed kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

ia-bot-ahmed verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
:::note
Sie können LSP-Server-Downloads automatisch deaktivieren, indem Sie die Umgebungsvariable `IA_BOT_AHMED_DISABLE_LSP_DOWNLOAD` auf `true` setzen.
:::
...
Wenn LSP aktiviert ist und ia-bot-ahmed eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer ia-bot-ahmed-Konfiguration aktivieren und anpassen.
