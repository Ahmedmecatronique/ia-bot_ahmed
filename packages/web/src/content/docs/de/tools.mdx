...
ia-bot-ahmed bringt eingebaute Tools mit und laesst sich ueber [Custom Tools](/docs/custom-tools) oder [MCP-Server](/docs/mcp-servers) erweitern.
...
Hier sind alle in ia-bot-ahmed verfuegbaren eingebauten Tools.
...
:::note
Dieses Tool ist nur verfuegbar, wenn `IA_BOT_AHMED_EXPERIMENTAL_LSP_TOOL=true` (oder `IA_BOT_AHMED_EXPERIMENTAL=true`) gesetzt ist.
:::
...
:::note
Dieses Tool ist nur verfuegbar, wenn der ia-bot-ahmed-Provider genutzt wird oder die Umgebungsvariable `IA_BOT_AHMED_ENABLE_EXA` auf einen 'truthy' Wert (z. B. `true` oder `1`) gesetzt ist.

Zum Aktivieren beim Start von ia-bot-ahmed:
