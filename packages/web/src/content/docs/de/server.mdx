---
title: Server
description: Nutze den ia-bot-ahmed-Server ueber HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Der Befehl `ia-bot-ahmed serve` startet einen headless HTTP-Server.
Er stellt einen OpenAPI-Endpunkt bereit, den ein ia-bot-ahmed-Client nutzen kann.
...
Setze `IA_BOT_AHMED_SERVER_PASSWORD`, um den Server mit HTTP Basic Auth zu schuetzen.
Der Benutzername ist standardmaessig `ia-bot-ahmed`, kann aber mit `IA_BOT_AHMED_SERVER_USERNAME` ueberschrieben werden. Das gilt fuer `ia-bot-ahmed serve` und `ia-bot-ahmed web`.
...
Wenn du `ia-bot-ahmed` startest, werden TUI und Server gestartet.
...
:::tip
Nutze den ia-bot-ahmed-Server, um ia-bot-ahmed programmatisch anzusteuern.
:::

Diese Architektur erlaubt mehrere Clients und programmatische Nutzung.

Mit `ia-bot-ahmed serve` startest du einen eigenstaendigen Server.
Laeuft bereits eine TUI, startet `ia-bot-ahmed serve` trotzdem eine neue Serverinstanz.
...
Dieses Muster nutzen auch die ia-bot-ahmed-[IDE](/docs/ide)-Plugins.
...
Der ia-bot-ahmed-Server stellt folgende APIs bereit.
