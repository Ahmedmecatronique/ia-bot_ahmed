---
title: Teilen
description: Teile ia-bot-ahmed-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu ia-bot-ahmed-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht ia-bot-ahmed Folgendes:
...
ia-bot-ahmed hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt ia-bot-ahmed den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`ia-bot-ahmed.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du ia-bot-ahmed in deiner Organisation einsetzt.
