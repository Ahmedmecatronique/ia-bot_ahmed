---
title: Zen
description: Kuratierte Modellliste direkt von ia-bot-ahmed.
---
...
ia-bot-ahmed Zen ist eine Liste von getesteten und verifizierten Modellen, die vom ia-bot-ahmed-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in ia-bot-ahmed. Du meldest dich bei ia-bot-ahmed Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um ia-bot-ahmed zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit ia-bot-ahmed funktionieren.
:::
...
ia-bot-ahmed Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

ia-bot-ahmed Zen funktioniert wie jeder andere Provider in ia-bot-ahmed.

1. Du meldest dich bei **<a href={console}>ia-bot-ahmed Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst ia-bot-ahmed Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner ia-bot-ahmed-Konfiguration verwendet das Format `ia-bot-ahmed/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `ia-bot-ahmed/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf ia-bot-ahmed verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf ia-bot-ahmed verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf ia-bot-ahmed verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf ia-bot-ahmed verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf ia-bot-ahmed verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben ia-bot-ahmed Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit ia-bot-ahmed auch jeden anderen Provider zu verwenden.
