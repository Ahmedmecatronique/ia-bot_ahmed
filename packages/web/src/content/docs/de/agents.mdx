...
Es gibt zwei Arten von Agenten in ia-bot-ahmed; Primäragenten und Subagenten.
...
ia-bot-ahmed verfügt über zwei integrierte Primäragenten: **Build** und **Plan**. Auch
...
Konfigurieren Sie Agenten in Ihrer `ia-bot-ahmed.json`-Konfigurationsdatei:
...
- Pro Projekt: `.ia-bot-ahmed/agents/`
...
Wenn keine Temperatur angegeben ist, verwendet ia-bot-ahmed modellspezifische Standardwerte; typischerweise 0 für die meisten Modelle, 0.55 für Qwen-Modelle.
...
Dieser Pfad ist relativ zum Speicherort der Konfigurationsdatei. Dies funktioniert sowohl für die globale ia-bot-ahmed-Konfiguration als auch für die projektspezifische Konfiguration.
...
Die Modell-ID in Ihrer ia-bot-ahmed-Konfiguration verwendet das Format `provider/model-id`. Wenn Sie beispielsweise [ia-bot-ahmed Zen](/docs/zen) verwenden, würden Sie `ia-bot-ahmed/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
...
:::tip
Führen Sie `ia-bot-ahmed models` aus, um eine Liste der verfügbaren Modelle anzubieten.
:::
...
:::tip
Haben Sie einen Agenten, den Sie gerne teilen möchten? [Reichen Sie einen PR ein](https://github.com/anomalyco/ia-bot-ahmed).
:::
