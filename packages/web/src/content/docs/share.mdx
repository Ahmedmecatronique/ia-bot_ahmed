---
title: Share
description: Share your ia-bot-ahmed conversations.
---

ia-bot-ahmed's share feature allows you to create public links to your ia-bot-ahmed conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, ia-bot-ahmed:
...
ia-bot-ahmed supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, ia-bot-ahmed uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `ia-bot-ahmed.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using ia-bot-ahmed in your organization.
