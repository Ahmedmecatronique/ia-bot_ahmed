...
Create `.ia-bot-ahmed/commands/test.md`:
...
You can add custom commands through the ia-bot-ahmed config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your ia-bot-ahmed [config](/docs/config):
...
- Per-project: `.ia-bot-ahmed/commands/`
...
ia-bot-ahmed includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
