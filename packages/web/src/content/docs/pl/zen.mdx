---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez ia-bot-ahmed.
---
...
ia-bot-ahmed Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół ia-bot-ahmed.

Zen działa jak każdy inny dostawca w ia-bot-ahmed. Logujesz się do ia-bot-ahmed Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z ia-bot-ahmed.
:::
...
ia-bot-ahmed Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

ia-bot-ahmed Zen działa jak każdy inny dostawca w ia-bot-ahmed.

1. Logujesz się do **<a href={console}>ia-bot-ahmed Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz ia-bot-ahmed Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji ia-bot-ahmed używa formatu
`ia-bot-ahmed/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`ia-bot-ahmed/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w ia-bot-ahmed przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w ia-bot-ahmed przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w ia-bot-ahmed przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w ia-bot-ahmed przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w ia-bot-ahmed przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy ia-bot-ahmed Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w ia-bot-ahmed także dowolnego innego dostawcy.
