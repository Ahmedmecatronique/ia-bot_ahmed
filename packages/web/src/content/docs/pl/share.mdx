---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące ia-bot-ahmed.
---

Funkcja udostępniania ia-bot-ahmed umożliwia tworzenie publicznych linków do konwersacji ia-bot-ahmed, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, ia-bot-ahmed:
...
ia-bot-ahmed obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie ia-bot-ahmed korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `ia-bot-ahmed.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu ia-bot-ahmed w Twojej organizacji.
