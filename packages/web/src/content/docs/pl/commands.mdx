...
Utwórz `.ia-bot-ahmed/commands/test.md`:
...
Możesz zdefiniować polecenia w `ia-bot-ahmed.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji ia-bot-ahmed:
...
- Globalnie: `~/.config/ia-bot-ahmed/commands/`
- Na projekt: `.ia-bot-ahmed/commands/`
...
ia-bot-ahmed zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
