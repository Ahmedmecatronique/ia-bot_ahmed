---
title: SDK
description: Typowany klient JS dla serwera ia-bot-ahmed.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS ia-bot-ahmed zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli ia-bot-ahmed.
...
Można przekazać obiekt konfiguracyjny, aby dostosować zachowanie. Instancja nadal pobiera `ia-bot-ahmed.json`, ale możesz zastąpić lub dodać konfigurację bezpośrednio:
...
Jeśli masz już działającą instancję ia-bot-ahmed, możesz utworzyć instancję klienta, aby się z nią połączyć:
