---
title: Serwery LSP
description: ia-bot-ahmed integruje się z serwerami LSP.
---

ia-bot-ahmed może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

ia-bot-ahmed posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
:::note
Możesz wyłączyć automatyczne pobieranie serwerów LSP, ustawiając zmienną środowiskową `IA_BOT_AHMED_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Gdy LSP jest włączony i ia-bot-ahmed otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji ia-bot-ahmed.
