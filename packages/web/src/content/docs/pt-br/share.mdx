---
title: Compartilhar
description: Compartilhe suas conversas do ia-bot-ahmed.
---

O recurso de compartilhamento do ia-bot-ahmed permite que você crie links públicos para suas conversas do ia-bot-ahmed, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o ia-bot-ahmed:
...
O ia-bot-ahmed suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o ia-bot-ahmed usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `ia-bot-ahmed.json` em seu projeto e faça o check-in no Git.
...
[Saiba mais](/docs/enterprise) sobre como usar o ia-bot-ahmed em sua organização.
