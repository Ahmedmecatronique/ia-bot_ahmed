---
title: SDK
description: Cliente JS seguro em tipos para o servidor ia-bot-ahmed.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

O SDK JS/TS do ia-bot-ahmed fornece um cliente seguro em tipos para interagir com o servidor.
Use-o para construir integrações e controlar o ia-bot-ahmed programaticamente.
...
Crie uma instância do ia-bot-ahmed:
...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `ia-bot-ahmed.json`, mas você pode substituir ou adicionar configuração inline:
...
Se você já tem uma instância do ia-bot-ahmed em execução, pode criar uma instância de cliente para se conectar a ela:
