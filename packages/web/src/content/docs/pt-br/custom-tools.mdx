...
description: Crie ferramentas que o LLM pode chamar no ia-bot-ahmed.
---

Ferramentas personalizadas são funções que você cria e que o LLM pode chamar durante as conversas. Elas funcionam junto com as [ferramentas integradas](/docs/tools) do ia-bot-ahmed, como `read`, `write` e `bash`.
...
- Localmente, colocando-as no diretório `.ia-bot-ahmed/tools/` do seu projeto.
- Ou globalmente, colocando-as em `~/.config/ia-bot-ahmed/tools/`.
