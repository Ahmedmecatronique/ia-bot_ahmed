---
title: Zen
description: Lista selecionada de modelos fornecidos pelo ia-bot-ahmed.
---
...
O ia-bot-ahmed Zen é uma lista de modelos testados e verificados fornecidos pela equipe do ia-bot-ahmed.

O Zen funciona como qualquer outro provedor no ia-bot-ahmed. Você faz login no ia-bot-ahmed Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o ia-bot-ahmed.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o ia-bot-ahmed.
:::
...
O ia-bot-ahmed Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O ia-bot-ahmed Zen funciona como qualquer outro provedor no ia-bot-ahmed.

1. Você faz login no **<a href={console}>ia-bot-ahmed Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona ia-bot-ahmed Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do ia-bot-ahmed usa o formato `ia-bot-ahmed/<model-id>`. Por exemplo, para GPT 5.5, você usaria `ia-bot-ahmed/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no ia-bot-ahmed por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no ia-bot-ahmed por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- North Mini Code Free está disponível no ia-bot-ahmed por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no ia-bot-ahmed por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no ia-bot-ahmed por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
Criamos o ia-bot-ahmed Zen para:
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o ia-bot-ahmed também.
