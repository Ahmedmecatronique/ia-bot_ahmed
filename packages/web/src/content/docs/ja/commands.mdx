...
`.ia-bot-ahmed/commands/test.md` を作成します。
...
カスタムコマンドは、ia-bot-ahmed 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

ia-bot-ahmed [設定](/docs/config)で `command` オプションを使用します:
...
- グローバル: `~/.config/ia-bot-ahmed/commands/`
- プロジェクトごと: `.ia-bot-ahmed/commands/`
...
ia-bot-ahmed には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。
