...
Schema-first LLM core for ia-bot-ahmed. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@ia-bot-ahmed/llm"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@ia-bot-ahmed/llm/providers"
