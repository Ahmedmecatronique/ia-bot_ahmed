...
import compareVideo from "../../asset/lander/ia-bot-ahmed-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/ia-bot-ahmed-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="ia-bot-ahmed:auth" content={loggedin() ? "true" : "false"} />
