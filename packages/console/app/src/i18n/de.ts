...
export const dict = {
  ...
  "notFound.title": "Nicht gefunden | ia-bot-ahmed",
  ...
  "temp.title": "ia-bot-ahmed | Für das Terminal gebauter AI-Coding-Agent",
  ...
  "temp.feature.zen.afterLink": "bereitgestellt von ia-bot-ahmed",
  ...
  "home.what.title": "Was ist ia-bot-ahmed?",
  "home.what.body":
  ...
  "home.growth.body":
    "Mit über <strong>{{stars}}</strong> GitHub-Stars, <strong>{{contributors}}</strong> Contributors und über <strong>{{commits}}</strong> Commits wird ia-bot-ahmed von über <strong>{{monthlyUsers}}</strong> Entwickler:innen jeden Monat genutzt und geschätzt.",
  ...
  "home.faq.q1": "Was ist ia-bot-ahmed?",
  "home.faq.a1":
    "ia-bot-ahmed ist ein Open-Source-Agent, der dir hilft, Code mit jedem KI-Modell zu schreiben und auszuführen. Er ist als Terminal-Interface, Desktop-App oder IDE-Erweiterung verfügbar.",
  "home.faq.q2": "Wie nutze ich ia-bot-ahmed?",
  "home.faq.a2.before": "Der einfachste Weg zu starten ist, die",
  "home.faq.a2.link": "Einführung zu lesen",
  "home.faq.q3": "Brauche ich zusätzliche AI-Abos, um ia-bot-ahmed zu nutzen?",
  "home.faq.a3.p1":
    "Nicht unbedingt, ia-bot-ahmed kommt mit einer Reihe kostenloser Modelle, die du ohne Account nutzen kannst.",
  ...
  "home.faq.a3.p3":
    "Während wir dazu raten, Zen zu nutzen, funktioniert ia-bot-ahmed auch mit allen beliebten Anbietern wie OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Du kannst sogar deine",
  "home.faq.a3.p4.localLink": "lokalen Modelle verbinden",
  "home.faq.q4": "Kann ich meine bestehenden AI-Abos mit ia-bot-ahmed nutzen?",
  "home.faq.a4.p1":
    "Ja, ia-bot-ahmed unterstützt Abos von allen großen Anbietern. Du kannst deine Claude Pro/Max, ChatGPT Plus/Pro oder GitHub Copilot Abos nutzen.",
  "home.faq.q5": "Kann ich ia-bot-ahmed nur im Terminal nutzen?",
  "home.faq.a5.beforeDesktop": "Nicht mehr! ia-bot-ahmed ist jetzt als App für",
  "home.faq.a5.desktop": "Desktop",
  "home.faq.a5.and": "und",
  "home.faq.a5.web": "Web verfügbar",
  "home.faq.q6": "Wie viel kostet ia-bot-ahmed?",
  "home.faq.a6":
    "ia-bot-ahmed ist zu 100% kostenlos. Es enthält auch eine Reihe kostenloser Modelle. Zusätzliche Kosten können entstehen, wenn du andere Anbieter verbindest.",
  ...
  "home.faq.q8": "Ist ia-bot-ahmed Open Source?",
  "home.faq.a8.p1": "Ja, ia-bot-ahmed ist vollständig Open Source. Der Quellcode ist öffentlich auf",
  ...
  "home.zenCta.body":
    "Zen gibt dir Zugriff auf ein handverlesenes Set an AI-Modellen, die ia-bot-ahmed speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität bei verschiedenen Anbietern – nutze validierte Modelle, die funktionieren.",
  "home.zenCta.link": "Erfahre mehr über Zen",

  "zen.title": "ia-bot-ahmed Zen | Ein kuratiertes Set zuverlässiger, optimierter Modelle für Coding-Agents",
  "zen.hero.title": "Zuverlässige, optimierte Modelle für Coding-Agents",
  "zen.hero.body":
    "Zen gibt dir Zugriff auf ein kuratiertes Set an AI-Modellen, die ia-bot-ahmed speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität – nutze validierte Modelle, die funktionieren.",

  "zen.faq.q1": "Was ist ia-bot-ahmed Zen?",
  "zen.faq.a1":
    "Zen ist ein kuratiertes Set an AI-Modellen, getestet und bewertet für Coding-Agents, erstellt vom Team hinter ia-bot-ahmed.",
  ...
  "zen.faq.a3":
    "Zen ist nicht gewinnorientiert. Zen gibt die Kosten der Modellanbieter an dich weiter. Je höher die Nutzung von Zen, desto besser kann ia-bot-ahmed Preise verhandeln und diese an dich weitergeben.",
  ...
  "zen.faq.a4.p3":
    "Um die Kosten zu decken, fügt ia-bot-ahmed nur eine kleine Bearbeitungsgebühr von $1.23 pro $20 Guthabenaufladung hinzu.",
  ...
  "zen.faq.a8":
    "Während Zen großartig mit ia-bot-ahmed funktioniert, kannst du Zen mit jedem Agent nutzen. Folge den Einrichtungsanweisungen in deinem bevorzugten Coding-Agent.",
  ...
  "zen.problem.subtitle": "Wir beheben das für alle, nicht nur für ia-bot-ahmed-Nutzer.",
  ...
  "zen.how.body": "Während wir dir raten, Zen mit ia-bot-ahmed zu nutzen, kannst du Zen mit jedem Agent nutzen.",
  ...
  "go.title": "ia-bot-ahmed Go | Kostengünstige Coding-Modelle für alle",
  ...
  "go.problem.body":
    "Wir konzentrieren uns darauf, die ia-bot-ahmed-Erfahrung so vielen Menschen wie möglich zugänglich zu machen. ia-bot-ahmed Go ist ein kostengünstiges Abonnement: $5 im ersten Monat, danach $10/Monat. Es bietet großzügige Limits und zuverlässigen Zugang zu den leistungsfähigsten Open-Source-Modellen.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go beginnt bei $5 für den ersten Monat, danach $10/Monat. Du kannst es mit ia-bot-ahmed oder jedem Agenten nutzen.",
  ...
  "go.faq.q1": "Was ist ia-bot-ahmed Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Die kostenlose Aktion für {{model}} ist beendet. Du kannst das Modell weiterhin nutzen, indem du ia-bot-ahmed Go abonnierst - {{link}}",

  "black.meta.title": "ia-bot-ahmed Black | Zugriff auf die weltweit besten Coding-Modelle",
  "black.meta.description": "Erhalte Zugriff auf Claude, GPT, Gemini und mehr mit ia-bot-ahmed Black Abos.",
  ...
  "black.workspace.title": "ia-bot-ahmed Black | Workspace wählen",
  ...
  "black.subscribe.success.title": "Du bist auf der ia-bot-ahmed Black Warteliste",
  ...
  "workspace.newUser.feature.lockin.body":
    "Nutze Zen mit jedem Coding-Agent und nutze weiterhin andere Anbieter mit ia-bot-ahmed, wann immer du willst.",
  ...
  "workspace.newUser.step.login.after": "aus und wähle ia-bot-ahmed",
  "workspace.newUser.step.pasteKey": "Füge deinen API Key ein",
  "workspace.newUser.step.models.before": "Starte ia-bot-ahmed und führe",
  ...
  "workspace.keys.subtitle": "Verwalte deine API Keys für den Zugriff auf ia-bot-ahmed-Dienste.",
  "workspace.keys.create": "API Key erstellen",
  "workspace.keys.placeholder": "Key-Namen eingeben",
  "workspace.keys.empty": "Erstelle einen ia-bot-ahmed Gateway API Key",
  ...
  "workspace.black.subscription.message": "Du hast ia-bot-ahmed Black für ${{plan}} pro Monat abonniert.",
  ...
  "workspace.black.waitlist.joined": "Du bist auf der Warteliste für den ${{plan}} pro Monat ia-bot-ahmed Black Plan.",
  "workspace.black.waitlist.ready": "Wir sind bereit, dich in den ${{plan}} pro Monat ia-bot-ahmed Black Plan aufzunehmen.",
  ...
  "workspace.lite.subscription.message": "Du hast ia-bot-ahmed Go abonniert.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wähle "ia-bot-ahmed Go" als Anbieter in deiner ia-bot-ahmed-Konfiguration, um Go-Modelle zu verwenden.',
  "workspace.lite.black.message":
    "Du hast derzeit ia-bot-ahmed Black abonniert oder stehst auf der Warteliste. Bitte kündige zuerst, wenn du zu Go wechseln möchtest.",
  "workspace.lite.other.message":
    "Ein anderes Mitglied in diesem Workspace hat ia-bot-ahmed Go bereits abonniert. Nur ein Mitglied pro Workspace kann abonnieren.",
  "workspace.lite.promo.description":
    "ia-bot-ahmed Go startet bei {{price}}, danach $10/Monat, und bietet zuverlässigen Zugang zu beliebten offenen Coding-Modellen mit großzügigen Nutzungslimits.",
  ...
  "download.meta.description": "Lade ia-bot-ahmed für macOS, Windows und Linux herunter",
  ...
  "download.faq.a3.beforeLocal":
    "Nicht unbedingt, aber wahrscheinlich. Du brauchst ein AI-Abo, wenn du ia-bot-ahmed mit einem bezahlten Anbieter verbinden willst, obwohl du mit",
  ...
  "download.faq.a3.afterZen":
    " zu nutzen, funktioniert ia-bot-ahmed mit allen populären Anbietern wie OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "ia-bot-ahmed ist 100% kostenlos.",
  "download.faq.a5.p2.beforeZen":
    "Zusätzliche Kosten entstehen durch dein Abo bei einem Modellanbieter. Während ia-bot-ahmed mit jedem Modellanbieter funktioniert, empfehlen wir",
  "download.faq.a5.p2.afterZen": " zu nutzen.",

  "download.faq.a6.p1":
    "Deine Daten und Informationen werden nur gespeichert, wenn du teilbare Links in ia-bot-ahmed erstellst.",
  "download.faq.a6.p2.beforeShare": "Erfahre mehr über",
  "download.faq.a6.shareLink": "Share-Pages",

  "enterprise.title": "ia-bot-ahmed | Enterprise-Lösungen für Ihre Organisation",
  "enterprise.meta.description": "Kontaktieren Sie ia-bot-ahmed für Enterprise-Lösungen",
  ...
  "enterprise.faq.q1": "Was ist ia-bot-ahmed Enterprise?",
  "enterprise.faq.a1":
    "ia-bot-ahmed Enterprise ist für Organisationen, die sicherstellen wollen, dass Code und Daten niemals ihre Infrastruktur verlassen. Dies geschieht durch eine zentrale Konfiguration, die in Ihr SSO und internes AI-Gateway integriert wird.",
  "enterprise.faq.q2": "Wie starte ich mit ia-bot-ahmed Enterprise?",
  "enterprise.faq.a2":
    "Starten Sie einfach mit einem internen Testlauf mit Ihrem Team. ia-bot-ahmed speichert standardmäßig weder Code noch Kontextdaten, was den Einstieg erleichtert. Kontaktieren Sie uns dann, um Preise und Implementierungsoptionen zu besprechen.",
  ...
  "enterprise.faq.q4": "Sind meine Daten mit ia-bot-ahmed Enterprise sicher?",
  "enterprise.faq.a4":
    "Ja. ia-bot-ahmed speichert weder Ihren Code noch Kontextdaten. Alle Verarbeitungen finden lokal oder über direkte API-Aufrufe an Ihren AI-Anbieter statt. Mit zentraler Konfiguration und SSO-Integration bleiben Ihre Daten sicher innerhalb der Infrastruktur Ihrer Organisation.",

  "brand.title": "ia-bot-ahmed | Marke",
  "brand.meta.description": "ia-bot-ahmed Markenrichtlinien",
  "brand.heading": "Markenrichtlinien",
  "brand.subtitle": "Ressourcen und Assets, die dir helfen, mit der ia-bot-ahmed-Marke zu arbeiten.",
  ...
  "changelog.hero.subtitle": "Neue Updates und Verbesserungen für ia-bot-ahmed",
