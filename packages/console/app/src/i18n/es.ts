...
export const dict = {
  ...
  "notFound.title": "No encontrado | ia-bot-ahmed",
  ...
  "app.meta.description": "ia-bot-ahmed - El agente de codificación de código abierto.",

  "home.title": "ia-bot-ahmed | El agente de codificación IA de código abierto",

  "temp.title": "ia-bot-ahmed | Agente de codificación IA creado para la terminal",
  ...
  "temp.feature.zen.afterLink": "proporcionada por ia-bot-ahmed",
  ...
  "temp.logoLightAlt": "logo de ia-bot-ahmed claro",
  "temp.logoDarkAlt": "logo de ia-bot-ahmed oscuro",
  ...
  "home.what.title": "¿Qué es ia-bot-ahmed?",
  "home.what.body":
    "ia-bot-ahmed es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, ia-bot-ahmed es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "ia-bot-ahmed no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es ia-bot-ahmed?",
  "home.faq.a1":
    "ia-bot-ahmed es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso ia-bot-ahmed?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar ia-bot-ahmed?",
  "home.faq.a3.p1":
    "No necesariamente, ia-bot-ahmed viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, ia-bot-ahmed también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con ia-bot-ahmed?",
  "home.faq.a4.p1":
    "Sí, ia-bot-ahmed soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar ia-bot-ahmed en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! ia-bot-ahmed ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta ia-bot-ahmed?",
  "home.faq.a6":
    "ia-bot-ahmed es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es ia-bot-ahmed de código abierto?",
  "home.faq.a8.p1": "Sí, ia-bot-ahmed es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que ia-bot-ahmed ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "ia-bot-ahmed Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que ia-bot-ahmed ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es ia-bot-ahmed Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de ia-bot-ahmed.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá ia-bot-ahmed negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, ia-bot-ahmed añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con ia-bot-ahmed, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de ia-bot-ahmed.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con ia-bot-ahmed, puedes usar Zen con cualquier agente.",
  ...
  "go.title": "ia-bot-ahmed Go | Modelos de programación de bajo coste para todos",
  ...
  "go.problem.body":
    "Nos enfocamos en llevar la experiencia de ia-bot-ahmed a tantas personas como sea posible. ia-bot-ahmed Go es una suscripción de bajo coste: $5 el primer mes, luego 10 $/mes. Proporciona límites generosos y acceso fiable a los modelos de código abierto más capaces.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go comienza en $5 el primer mes, luego 10 $/mes. Puedes usarlo con ia-bot-ahmed o cualquier agente.",
  ...
  "go.faq.q1": "¿Qué es ia-bot-ahmed Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "La promoción gratuita de {{model}} ha finalizado. Puedes seguir usando el modelo suscribiéndote a ia-bot-ahmed Go - {{link}}",

  "black.meta.title": "ia-bot-ahmed Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de ia-bot-ahmed Black.",
  ...
  "black.subscribe.title": "Suscribirse a ia-bot-ahmed Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de ia-bot-ahmed Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con ia-bot-ahmed cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona ia-bot-ahmed",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia ia-bot-ahmed y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de ia-bot-ahmed.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de ia-bot-ahmed Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a ia-bot-ahmed Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan ia-bot-ahmed Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan ia-bot-ahmed Black de ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.message": "Estás suscrito a ia-bot-ahmed Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "ia-bot-ahmed Go" como proveedor en tu configuración de ia-bot-ahmed para usar los modelos Go.',
  "workspace.lite.black.message":
    "Actualmente estás suscrito a ia-bot-ahmed Black o estás en la lista de espera. Por favor, cancela la suscripción primero si deseas cambiar a Go.",
  "workspace.lite.other.message":
    "Otro miembro de este espacio de trabajo ya está suscrito a ia-bot-ahmed Go. Solo un miembro por espacio de trabajo puede suscribirse.",
  "workspace.lite.promo.description":
    "ia-bot-ahmed Go comienza en {{price}}, luego $10/mes, y ofrece acceso confiable a modelos de codificación abiertos populares con límites de uso generosos.",
  ...
  "download.meta.description": "Descarga ia-bot-ahmed para macOS, Windows y Linux",
  "download.hero.title": "Descargar ia-bot-ahmed",
  ...
  "download.section.extensions": "Extensiones ia-bot-ahmed",
  "download.section.integrations": "Integraciones ia-bot-ahmed",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar ia-bot-ahmed a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", ia-bot-ahmed funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "ia-bot-ahmed es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque ia-bot-ahmed funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en ia-bot-ahmed.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "ia-bot-ahmed | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a ia-bot-ahmed para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "ia-bot-ahmed opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es ia-bot-ahmed Enterprise?",
  "enterprise.faq.a1":
    "ia-bot-ahmed Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con ia-bot-ahmed Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. ia-bot-ahmed por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con ia-bot-ahmed Enterprise?",
  "enterprise.faq.a4":
    "Sí. ia-bot-ahmed no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "ia-bot-ahmed | Marca",
  "brand.meta.description": "Guías de marca de ia-bot-ahmed",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca ia-bot-ahmed.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "ia-bot-ahmed | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de ia-bot-ahmed",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para ia-bot-ahmed",
