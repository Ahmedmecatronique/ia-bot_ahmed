...
export const dict = {
  ...
  "notFound.title": "Nie znaleziono | ia-bot-ahmed",
  "notFound.heading": "404 - Nie znaleziono strony",
  "notFound.home": "Strona główna",
  "notFound.docs": "Dokumentacja",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "jasne logo ia-bot-ahmed",
  "notFound.logoDarkAlt": "ciemne logo ia-bot-ahmed",
  ...
  "app.meta.description": "ia-bot-ahmed - Otwartoźródłowy agent programistyczny.",
  ...
  "temp.feature.zen.afterLink": "dostarczana przez ia-bot-ahmed",
  ...
  "temp.logoLightAlt": "jasne logo ia-bot-ahmed",
  "temp.logoDarkAlt": "ciemne logo ia-bot-ahmed",
  ...
  "home.what.title": "Czym jest ia-bot-ahmed?",
  "home.what.body":
    "ia-bot-ahmed to open source'owy agent, który pomaga pisać kod w terminalu, IDE lub aplikacji desktopowej.",
  ...
  "home.growth.body":
    "Z ponad <strong>{{stars}}</strong> gwiazdkami na GitHubie, <strong>{{contributors}}</strong> współtwórcami i ponad <strong>{{commits}}</strong> commitami, ia-bot-ahmed jest używany i ceniony przez ponad <strong>{{monthlyUsers}}</strong> deweloperów każdego miesiąca.",
  ...
  "home.privacy.body":
    "ia-bot-ahmed nie przechowuje Twojego kodu ani danych kontekstowych, dzięki czemu może działać w środowiskach wrażliwych na prywatność.",
  "home.privacy.learnMore": "Dowiedz się więcej o",
  "home.privacy.link": "prywatności",

  "home.faq.q1": "Czym jest ia-bot-ahmed?",
  "home.faq.a1":
    "ia-bot-ahmed to open source'owy agent, który pomaga pisać i uruchamiać kod z dowolnym modelem AI. Jest dostępny jako interfejs terminalowy, aplikacja desktopowa lub rozszerzenie IDE.",
  "home.faq.q2": "Jak korzystać z ia-bot-ahmed?",
  "home.faq.a2.before": "Najłatwiej zacząć od przeczytania",
  "home.faq.a2.link": "wprowadzenia",
  "home.faq.q3": "Czy potrzebuję dodatkowych subskrypcji AI, aby używać ia-bot-ahmed?",
  "home.faq.a3.p1":
    "Niekoniecznie. ia-bot-ahmed posiada zestaw darmowych modeli, z których możesz korzystać bez zakładania konta.",
  "home.faq.a3.p2.beforeZen": "Poza tym możesz używać dowolnych popularnych modeli do kodowania, tworząc konto",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Chociaż zachęcamy do korzystania z Zen, ia-bot-ahmed działa również ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itp.",
  "home.faq.a3.p4.beforeLocal": "Możesz nawet podłączyć swoje",
  "home.faq.a3.p4.localLink": "lokalne modele",
  "home.faq.q4": "Czy mogę używać moich istniejących subskrypcji AI z ia-bot-ahmed?",
  "home.faq.a4.p1":
    "Tak, ia-bot-ahmed obsługuje plany subskrypcyjne od wszystkich głównych dostawców. Możesz używać swoich subskrypcji Claude Pro/Max, ChatGPT Plus/Pro lub GitHub Copilot.",
  "home.faq.q5": "Czy mogę używać ia-bot-ahmed tylko w terminalu?",
  "home.faq.a5.beforeDesktop": "Już nie! ia-bot-ahmed jest teraz dostępny jako aplikacja na",
  "home.faq.a5.desktop": "pulpit (desktop)",
  "home.faq.a5.and": "i",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Ile kosztuje ia-bot-ahmed?",
  "home.faq.a6":
    "ia-bot-ahmed jest w 100% darmowy. Zawiera również zestaw darmowych modeli. Mogą pojawić się dodatkowe koszty, jeśli podłączysz innego dostawcę.",
  ...
  "home.faq.q8": "Czy ia-bot-ahmed jest open source?",
  "home.faq.a8.p1": "Tak, ia-bot-ahmed jest w pełni open source. Kod źródłowy jest publicznie dostępny na",
  ...
  "home.zenCta.body":
    "Zen daje dostęp do wyselekcjonowanego zestawu modeli AI, które ia-bot-ahmed przetestował i sprawdził (benchmark) specjalnie dla agentów kodujących. Nie musisz martwić się o niespójną wydajność i jakość u różnych dostawców, używaj sprawdzonych modeli, które działają.",
  "home.zenCta.link": "Dowiedz się więcej o Zen",

  "zen.title": "ia-bot-ahmed Zen | Wyselekcjonowany zestaw niezawodnych, zoptymalizowanych modeli dla agentów kodujących",
  "zen.hero.title": "Niezawodne, zoptymalizowane modele dla agentów kodujących",
  "zen.hero.body":
    "Zen daje dostęp do wyselekcjonowanego zestawu modeli AI, które ia-bot-ahmed przetestował i sprawdził (benchmark) specjalnie dla agentów kodujących. Nie musisz martwić się o niespójną wydajność i jakość, używaj sprawdzonych modeli, które działają.",

  "zen.faq.q1": "Czym jest ia-bot-ahmed Zen?",
  "zen.faq.a1":
    "Zen to wyselekcjonowany zestaw modeli AI przetestowanych i sprawdzonych pod kątem agentów kodujących, stworzony przez zespół stojący za ia-bot-ahmed.",
  ...
  "zen.faq.a3":
    "Zen nie jest nastawiony na zysk. Zen przekazuje koszty od dostawców modeli bezpośrednio do Ciebie. Im większe użycie Zen, tym lepsze stawki ia-bot-ahmed może wynegocjować i przekazać Tobie.",
  ...
  "zen.faq.a4.p3":
    "Aby pokryć koszty, ia-bot-ahmed dolicza jedynie niewielką opłatę za przetwarzanie płatności w wysokości $1.23 przy każdym doładowaniu salda o $20.",
  ...
  "zen.faq.a8":
    "Chociaż Zen świetnie działa z ia-bot-ahmed, możesz używać Zen z dowolnym agentem. Postępuj zgodnie z instrukcjami konfiguracji w swoim preferowanym agencie.",
  ...
  "zen.problem.subtitle": "Naprawiamy to dla wszystkich, nie tylko dla użytkowników ia-bot-ahmed.",
  ...
  "zen.how.body": "Chociaż sugerujemy używanie Zen z ia-bot-ahmed, możesz używać Zen z dowolnym agentem.",
  ...
  "go.title": "ia-bot-ahmed Go | Niskokosztowe modele do kodowania dla każdego",
  ...
  "go.problem.body":
    "Skupiamy się na udostępnieniu doświadczenia ia-bot-ahmed jak największej liczbie osób. ia-bot-ahmed Go to tania subskrypcja: $5 za pierwszy miesiąc, potem $10/miesiąc. Zapewnia hojne limity i niezawodny dostęp do najbardziej wydajnych modeli open source.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go zaczyna się od $5 za pierwszy miesiąc, potem $10/miesiąc. Możesz go używać z ia-bot-ahmed lub dowolnym agentem.",
  ...
  "go.faq.q1": "Czym jest ia-bot-ahmed Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Bezpłatna promocja {{model}} dobiegła końca. Możesz dalej korzystać z modelu, subskrybując ia-bot-ahmed Go - {{link}}",

  "black.meta.title": "ia-bot-ahmed Black | Dostęp do najlepszych na świecie modeli kodujących",
  "black.meta.description": "Uzyskaj dostęp do Claude, GPT, Gemini i innych dzięki planom subskrypcji ia-bot-ahmed Black.",
  ...
  "black.subscribe.title": "Subskrybuj ia-bot-ahmed Black",
  ...
  "black.subscribe.success.title": "Jesteś na liście oczekujących ia-bot-ahmed Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Używaj Zen z dowolnym agentem kodującym i kontynuuj korzystanie z innych dostawców z ia-bot-ahmed, kiedy tylko chcesz.",
  ...
  "workspace.newUser.step.login.after": "i wybierz ia-bot-ahmed",
  "workspace.newUser.step.pasteKey": "Wklej swój klucz API",
  "workspace.newUser.step.models.before": "Uruchom ia-bot-ahmed i wpisz",
  ...
  "workspace.keys.subtitle": "Zarządzaj kluczami API do usług ia-bot-ahmed.",
  "workspace.keys.create": "Utwórz klucz API",
  "workspace.keys.placeholder": "Wpisz nazwę klucza",
  "workspace.keys.empty": "Utwórz klucz API bramy ia-bot-ahmed",
  ...
  "workspace.black.subscription.message": "Subskrybujesz ia-bot-ahmed Black za ${{plan}} miesięcznie.",
  ...
  "workspace.black.waitlist.joined": "Jesteś na liście oczekujących na plan ia-bot-ahmed Black za ${{plan}} miesięcznie.",
  "workspace.black.waitlist.ready": "Jesteśmy gotowi zapisać Cię do planu ia-bot-ahmed Black za ${{plan}} miesięcznie.",
  ...
  "workspace.lite.subscription.message": "Subskrybujesz ia-bot-ahmed Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wybierz "ia-bot-ahmed Go" jako dostawcę w konfiguracji ia-bot-ahmed, aby używać modeli Go.',
  "workspace.lite.black.message":
    "Obecnie subskrybujesz ia-bot-ahmed Black lub jesteś na liście oczekujących. Jeśli chcesz przejść na Go, najpierw anuluj subskrypcję.",
  "workspace.lite.other.message":
    "Inny członek tego obszaru roboczego już subskrybuje ia-bot-ahmed Go. Tylko jeden członek na obszar roboczy może subskrybować.",
  "workspace.lite.promo.description":
    "ia-bot-ahmed Go zaczyna się od {{price}}, potem $10/miesiąc, i zapewnia niezawodny dostęp do popularnych otwartych modeli kodowania z hojnymi limitami użycia.",
  ...
  "download.meta.description": "Pobierz ia-bot-ahmed na macOS, Windows i Linux",
  "download.hero.title": "Pobierz ia-bot-ahmed",
  "download.hero.subtitle": "Dostępne w wersji Beta na macOS, Windows i Linux",
  "download.hero.button": "Pobierz na {{os}}",
  "download.section.terminal": "Terminal ia-bot-ahmed",
  "download.section.desktop": "Pulpit ia-bot-ahmed (Beta)",
  "download.section.extensions": "Rozszerzenia ia-bot-ahmed",
  "download.section.integrations": "Integracje ia-bot-ahmed",
  ...
  "download.faq.a3.beforeLocal":
    "Niekoniecznie, ale prawdopodobnie. Będziesz potrzebować subskrypcji AI, jeśli chcesz połączyć ia-bot-ahmed z płatnym dostawcą, chociaż możesz pracować z",
  ...
  "download.faq.a3.afterZen":
    ", ia-bot-ahmed współpracuje ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itp.",

  "download.faq.a5.p1": "ia-bot-ahmed jest w 100% darmowy.",
  "download.faq.a5.p2.beforeZen":
    "Wszelkie dodatkowe koszty będą pochodzić z Twojej subskrypcji u dostawcy modelu. Chociaż ia-bot-ahmed współpracuje z dowolnym dostawcą modeli, zalecamy korzystanie z",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Twoje dane i informacje są przechowywane tylko wtedy, gdy tworzysz linki do udostępniania w ia-bot-ahmed.",
  "download.faq.a6.p2.beforeShare": "Dowiedz się więcej o",
  "download.faq.a6.shareLink": "stronach udostępniania",

  "enterprise.title": "ia-bot-ahmed | Rozwiązania Enterprise dla Twojej organizacji",
  "enterprise.meta.description": "Skontaktuj się z ia-bot-ahmed w sprawie rozwiązań dla przedsiębiorstw",
  "enterprise.hero.title": "Twój kod jest Twój",
  "enterprise.hero.body1":
    "ia-bot-ahmed działa bezpiecznie wewnątrz Twojej organizacji bez przechowywania danych czy kontekstu, oraz bez ograniczeń licencyjnych czy roszczeń własnościowych. Rozpocznij okres próbny ze swoim zespołem, a następnie wdróż go w całej organizacji, integrując z SSO i wewnętrzną bramą AI.",
  ...
  "enterprise.faq.q1": "Czym jest ia-bot-ahmed Enterprise?",
  "enterprise.faq.a1":
    "ia-bot-ahmed Enterprise jest dla organizacji, które chcą mieć pewność, że ich kod i dane nigdy nie opuszczą ich infrastruktury. Można to osiągnąć dzięki scentralizowanej konfiguracji, która integruje się z Twoim SSO i wewnętrzną bramą AI.",
  "enterprise.faq.q2": "Jak zacząć z ia-bot-ahmed Enterprise?",
  "enterprise.faq.a2":
    "Po prostu rozpocznij wewnętrzny okres próbny ze swoim zespołem. ia-bot-ahmed domyślnie nie przechowuje Twojego kodu ani danych kontekstowych, co ułatwia start. Następnie skontaktuj się z nami, aby omówić opcje cenowe i wdrożeniowe.",
  ...
  "enterprise.faq.q4": "Czy moje dane są bezpieczne z ia-bot-ahmed Enterprise?",
  "enterprise.faq.a4":
    "Tak. ia-bot-ahmed nie przechowuje Twojego kodu ani danych kontekstowych. Całe przetwarzanie odbywa się lokalnie lub poprzez bezpośrednie wywołania API do Twojego dostawcy AI. Dzięki centralnej konfiguracji i integracji SSO, Twoje dane pozostają bezpieczne w infrastrukturze Twojej organizacji.",

  "brand.title": "ia-bot-ahmed | Marka",
  "brand.meta.description": "Wytyczne marki ia-bot-ahmed",
  "brand.heading": "Wytyczne marki",
  "brand.subtitle": "Zasoby i aktywa, które pomogą Ci pracować z marką ia-bot-ahmed.",
  "brand.downloadAll": "Pobierz wszystkie zasoby",

  "changelog.title": "ia-bot-ahmed | Dziennik zmian",
  "changelog.meta.description": "Notatki o wydaniu i dziennik zmian ia-bot-ahmed",
  "changelog.hero.title": "Dziennik zmian",
  "changelog.hero.subtitle": "Nowe aktualizacje i ulepszenia ia-bot-ahmed",
