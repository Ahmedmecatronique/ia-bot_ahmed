export const dict = {
  ...
  "app.meta.description": "ia-bot-ahmed - The open source coding agent.",

  "home.title": "ia-bot-ahmed | The open source AI coding agent",

  "temp.title": "ia-bot-ahmed | AI coding agent built for the terminal",
  ...
  "temp.screenshot.alt": "ia-bot-ahmed TUI with tokyonight theme",
  ...
  "home.privacy.body":
    "ia-bot-ahmed does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
