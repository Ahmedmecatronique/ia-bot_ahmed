...
export const dict = {
  ...
  "notFound.title": "Non trovato | IaBotAhmed",
  "notFound.heading": "404 - Pagina non trovata",
  "notFound.home": "Home",
  "notFound.docs": "Documentazione",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo chiaro di IaBotAhmed",
  "notFound.logoDarkAlt": "logo scuro di IaBotAhmed",
  ...
  "error.alreadySubscribed": "Questo workspace ha giÃ  un abbonamento",
  "error.limitRequired": "Il limite Ã¨ richiesto.",
  "error.monthlyLimitInvalid": "Imposta un limite mensile valido.",
  "error.workspaceNameRequired": "Il nome del workspace Ã¨ richiesto.",
  "error.nameTooLong": "Il nome deve essere di 255 caratteri o meno.",
  "error.emailRequired": "L'email Ã¨ richiesta",
  "error.roleRequired": "Il ruolo Ã¨ richiesto",
  "error.idRequired": "L'ID Ã¨ richiesto",
  "error.nameRequired": "Il nome Ã¨ richiesto",
  "error.providerRequired": "Il provider Ã¨ richiesto",
  "error.apiKeyRequired": "La chiave API Ã¨ richiesta",
  "error.modelRequired": "Il modello Ã¨ richiesto",
  ...
  "app.meta.description": "ia-bot-ahmed - L'agente di programmazione open source.",

  "home.title": "ia-bot-ahmed | L'agente di coding IA open source",

  "temp.title": "ia-bot-ahmed | Agente di coding IA costruito per il terminale",
  ...
  "temp.feature.zen.afterLink": "fornita da IaBotAhmed",
  "temp.feature.models.beforeLink": "Supporta 75+ provider LLM tramite",
  "temp.feature.models.afterLink": ", inclusi modelli locali",
  "temp.screenshot.caption": "ia-bot-ahmed TUI con il tema tokyonight",
  "temp.screenshot.alt": "ia-bot-ahmed TUI con tema tokyonight",
  "temp.logoLightAlt": "logo chiaro di IaBotAhmed",
  "temp.logoDarkAlt": "logo scuro di IaBotAhmed",
  ...
  "home.what.title": "Che cos'Ã¨ IaBotAhmed?",
  "home.what.body": "ia-bot-ahmed Ã¨ un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "home.what.multiSession.body": "Avvia piÃ¹ agenti in parallelo sullo stesso progetto",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, IaBotAhmed Ã¨ usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "ia-bot-ahmed non archivia il tuo codice nÃ© i dati di contesto, cosÃ¬ puÃ² operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di piÃ¹ su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'Ã¨ IaBotAhmed?",
  "home.faq.a1":
    "ia-bot-ahmed Ã¨ un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. Ãˆ disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso IaBotAhmed?",
  "home.faq.a2.before": "Il modo piÃ¹ semplice per iniziare Ã¨ leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare IaBotAhmed?",
  "home.faq.a3.p1":
    "Non necessariamente: IaBotAhmed include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, IaBotAhmed funziona anche con i provider piÃ¹ diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con IaBotAhmed?",
  "home.faq.a4.p1":
    "SÃ¬, IaBotAhmed supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare IaBotAhmed solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non piÃ¹! IaBotAhmed ora Ã¨ disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa IaBotAhmed?",
  "home.faq.a6":
    "ia-bot-ahmed Ã¨ gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.a7.p2.beforeModels": "Scopri di piÃ¹ su",
  "home.faq.a7.p2.modelsLink": "i nostri modelli",
  "home.faq.a7.p2.and": "e",
  "home.faq.a7.p2.shareLink": "le pagine di condivisione",
  "home.faq.q8": "ia-bot-ahmed Ã¨ open source?",
  "home.faq.a8.p1": "SÃ¬, IaBotAhmed Ã¨ completamente open source. Il codice sorgente Ã¨ pubblico su",
  "home.faq.a8.p2": "sotto la",
  "home.faq.a8.mitLicense": "Licenza MIT",
  "home.faq.a8.p3":
    ", il che significa che chiunque puÃ² usarlo, modificarlo o contribuire al suo sviluppo. Chiunque nella comunitÃ  puÃ² aprire issue, inviare pull request ed estendere le funzionalitÃ .",

  "home.zenCta.title": "Accedi a modelli affidabili e ottimizzati per agenti di coding",
  "home.zenCta.body":
    "Zen ti dÃ  accesso a una selezione di modelli di IA che IaBotAhmed ha testato e benchmarkato specificamente per agenti di coding. Niente piÃ¹ preoccupazioni per prestazioni e qualitÃ  incoerenti tra provider: usa modelli validati che funzionano.",
  "home.zenCta.link": "Scopri Zen",

  "zen.title": "ia-bot-ahmed Zen | Una selezione curata di modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.title": "Accedi a modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.body":
    "Zen ti dÃ  accesso a una selezione di modelli di IA che IaBotAhmed ha testato e benchmarkato specificamente per agenti di coding. Niente piÃ¹ preoccupazioni per prestazioni e qualitÃ  incoerenti tra provider: usa modelli validati che funzionano.",

  "zen.faq.q1": "Cos'Ã¨ IaBotAhmed Zen?",
  "zen.faq.a1":
    "Zen Ã¨ un set curato di modelli di IA testati e benchmarkati per agenti di coding, creato dal team dietro IaBotAhmed.",
  "zen.faq.q2": "Cosa rende Zen piÃ¹ accurato?",
  "zen.faq.a2":
  ...
  "zen.faq.q3": "Zen Ã¨ piÃ¹ economico?",
  "zen.faq.a3":
    "Zen non Ã¨ a scopo di lucro. Zen ribalta i costi dei provider di modelli direttamente su di te. PiÃ¹ Zen viene usato, piÃ¹ IaBotAhmed puÃ² negoziare tariffe migliori e passarle a te.",
  "zen.faq.q4": "Quanto costa Zen?",
  "zen.faq.a4.p1.beforePricing": "Zen",
  "zen.faq.a4.p1.pricingLink": "addebita per richiesta",
  "zen.faq.a4.p1.afterPricing": "senza ricarichi, quindi paghi esattamente ciÃ² che addebita il provider del modello.",
  ...
  "zen.faq.a4.p3":
    "Per coprire i costi, IaBotAhmed aggiunge solo una piccola commissione di elaborazione del pagamento di $1.23 per ogni ricarica di saldo da $20.",
  ...
  "zen.faq.a6": "SÃ¬, puoi impostare limiti di spesa mensuali nel tuo account.",
  "zen.faq.q7": "Posso annullare?",
  "zen.faq.a7": "SÃ¬, puoi disattivare la fatturazione in qualsiasi momento e usare il saldo rimanente.",
  "zen.faq.q8": "Posso usare Zen con altri agenti di coding?",
  "zen.faq.a8":
    "Anche se Zen funziona alla grande con IaBotAhmed, puoi usare Zen con qualsiasi agente. Segui le istruzioni di configurazione nel tuo agente di coding preferito.",
  ...
  "zen.problem.subtitle": "Stiamo risolvendo questo problema per tutti, non solo per gli utenti IaBotAhmed.",
  ...
  "zen.how.body": "Anche se ti consigliamo di utilizzare Zen con IaBotAhmed, puoi utilizzare Zen con qualsiasi agente.",
  ...
  "zen.privacy.title": "La tua privacy Ã¨ importante per noi",
  "zen.privacy.beforeExceptions":
    "Tutti i modelli Zen sono ospitati negli Stati Uniti. I provider seguono una policy di zero-retention e non usano i tuoi dati per l'addestramento dei modelli, con le",
  "zen.privacy.exceptionsLink": "seguenti eccezioni",

  "go.title": "ia-bot-ahmed Go | Modelli di coding a basso costo per tutti",
  ...
  "go.hero.body":
    "Go porta il coding agentico ai programmatori di tutto il mondo. Offrendo limiti generosi e un accesso affidabile ai modelli open source piÃ¹ capaci, in modo da poter costruire con agenti potenti senza preoccuparsi dei costi o della disponibilitÃ .",
  ...
  "go.testimonials.dax.quoteAfter": "ha cambiato la vita, Ã¨ davvero una scelta ovvia.",
  ...
  "go.testimonials.adam.quoteAfter": "abbastanza. Seriamente, Ã¨ davvero buono.",
  ...
  "go.problem.body":
    "Ci concentriamo nel portare l'esperienza IaBotAhmed a quante piÃ¹ persone possibile. IaBotAhmed Go Ã¨ un abbonamento a basso costo: $5 il primo mese, poi $10/mese. Offre limiti generosi e accesso affidabile ai modelli open source piÃ¹ capaci.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go inizia a $5 per il primo mese, poi $10/mese. Puoi usarlo con IaBotAhmed o qualsiasi agente.",
  ...
  "go.privacy.title": "La tua privacy Ã¨ importante per noi",
  "go.privacy.body":
    "Il piano Ã¨ progettato principalmente per gli utenti internazionali, con modelli ospitati negli Stati Uniti, UE e Singapore per un accesso globale stabile.",
  ...
  "go.faq.q1": "Che cos'Ã¨ IaBotAhmed Go?",
  "go.faq.a1":
    "Go Ã¨ un abbonamento a basso costo che ti dÃ  un accesso affidabile a modelli open source capaci per il coding agentico.",
  ...
  "go.faq.q3": "Go Ã¨ lo stesso di Zen?",
  "go.faq.a3":
    "No. Zen Ã¨ a consumo, mentre Go inizia a $5 per il primo mese, poi $10/mese, con limiti generosi e accesso affidabile ai modelli open source GLM-5.2, GLM-5.1, Kimi K2.7 Code, Kimi K2.6, MiMo-V2.5-Pro, MiMo-V2.5, Qwen3.7 Max, Qwen3.7 Plus, Qwen3.6 Plus, MiniMax M2.7, MiniMax M3, DeepSeek V4 Pro e DeepSeek V4 Flash.",
  ...
  "go.faq.a5.body":
    "Il piano Ã¨ progettato principalmente per gli utenti internazionali, con modelli ospitati negli Stati Uniti, UE e Singapore per un accesso globale stabile. I nostri provider seguono una policy di zero-retention e non usano i tuoi dati per l'addestramento dei modelli.",
  "go.faq.a5.beforeExceptions":
    "I modelli Go sono ospitati negli Stati Uniti. I provider seguono una policy di zero-retention e non usano i tuoi dati per l'addestramento dei modelli, con le",
  "go.faq.a5.exceptionsLink": "seguenti eccezioni",
  "go.faq.q6": "Posso ricaricare il credito?",
  "go.faq.a6": "Se hai bisogno di piÃ¹ utilizzo, puoi ricaricare il credito nel tuo account.",
  "go.faq.q7": "Posso annullare?",
  "go.faq.a7": "SÃ¬, puoi annullare in qualsiasi momento.",
  "go.faq.q8": "Posso usare Go con altri agenti di coding?",
  "go.faq.a8":
    "SÃ¬, puoi usare Go con qualsiasi agente. Segui le istruzioni di configurazione nel tuo agente di coding preferito.",

  "go.faq.q9": "Qual Ã¨ la differenza tra i modelli gratuiti e Go?",
  "go.faq.a9":
    "I modelli gratuiti includono Big Pickle piÃ¹ modelli promozionali disponibili al momento, con una quota di 200 richieste/giorno. Go include GLM-5.2, GLM-5.1, Kimi K2.7 Code, Kimi K2.6, MiMo-V2.5-Pro, MiMo-V2.5, Qwen3.7 Max, Qwen3.7 Plus, Qwen3.6 Plus, MiniMax M2.7, MiniMax M3, DeepSeek V4 Pro e DeepSeek V4 Flash con quote di richiesta piÃ¹ elevate applicate su finestre mobili (5 ore, settimanale e mensile), approssimativamente equivalenti a $12 ogni 5 ore, $30 a settimana e $60 al mese (il conteggio effettivo delle richieste varia in base al modello e all'utilizzo).",

  "zen.api.error.rateLimitExceeded": "Limite di richieste superato. Riprova piÃ¹ tardi.",
  ...
  "zen.api.error.modelDisabled": "Il modello Ã¨ disabilitato",
  "zen.api.error.trialEnded":
    "La promozione gratuita di {{model}} Ã¨ terminata. Puoi continuare a usare il modello abbonandoti a IaBotAhmed Go - {{link}}",

  "black.meta.title": "ia-bot-ahmed Black | Accedi ai migliori modelli di coding al mondo",
  "black.meta.description":
    "Ottieni l'accesso a Claude, GPT, Gemini e altri con i piani di abbonamento IaBotAhmed Black.",
  "black.hero.title": "Accedi ai migliori modelli di coding al mondo",
  "black.hero.subtitle": "Inclusi Claude, GPT, Gemini e altri",
  "black.title": "ia-bot-ahmed Black | Prezzi",
  "black.paused": "L'iscrizione al piano Black Ã¨ temporaneamente sospesa.",
  "black.plan.icon20": "Piano Black 20",
  "black.plan.icon100": "Piano Black 100",
  "black.plan.icon200": "Piano Black 200",
  "black.plan.multiplier100": "5x piÃ¹ utilizzo rispetto a Black 20",
  "black.plan.multiplier200": "20x piÃ¹ utilizzo rispetto a Black 20",
  "black.price.perMonth": "al mese",
  "black.price.perPersonBilledMonthly": "per persona fatturato mensilmente",
  "black.terms.1": "Il tuo abbonamento non inizierÃ  immediatamente",
  "black.terms.2": "Verrai aggiunto alla lista d'attesa e attivato presto",
  "black.terms.3": "La tua carta verrÃ  addebitata solo quando il tuo abbonamento sarÃ  attivato",
  "black.terms.4":
  ...
  "black.workspace.title": "ia-bot-ahmed Black | Seleziona Workspace",
  "black.workspace.selectPlan": "Seleziona un workspace per questo piano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Abbonati a IaBotAhmed Black",
  ...
  "black.subscribe.error.generic": "Si Ã¨ verificato un errore",
  "black.subscribe.error.invalidPlan": "Piano non valido",
  "black.subscribe.error.workspaceRequired": "ID Workspace richiesto",
  "black.subscribe.error.alreadySubscribed": "Questo workspace ha giÃ  un abbonamento",
  "black.subscribe.processing": "Elaborazione...",
  "black.subscribe.submit": "Abbonati ${{plan}}",
  "black.subscribe.form.chargeNotice": "Ti verrÃ  addebitato solo quando il tuo abbonamento sarÃ  attivato",
  "black.subscribe.success.title": "Sei nella lista d'attesa di IaBotAhmed Black",
  ...
  "black.subscribe.success.chargeNotice": "La tua carta verrÃ  addebitata quando il tuo abbonamento sarÃ  attivato",
  ...
  "workspace.newUser.feature.quality.title": "Massima qualitÃ ",
  "workspace.newUser.feature.quality.body":
    "Accedi a modelli configurati per prestazioni ottimali - nessun downgrade o instradamento verso provider piÃ¹ economici.",
  "workspace.newUser.feature.lockin.title": "Nessun lock-in",
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con qualsiasi agente di coding, e continua a usare altri provider con IaBotAhmed quando vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona IaBotAhmed",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia IaBotAhmed ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi IaBotAhmed.",
  "workspace.keys.create": "Crea Chiave API",
  "workspace.keys.placeholder": "Inserisci nome chiave",
  "workspace.keys.empty": "Crea una chiave API IaBotAhmed Gateway",
  ...
  "workspace.members.role.adminDescription": "PuÃ² gestire modelli, membri e fatturazione",
  "workspace.members.role.member": "Membro",
  "workspace.members.role.memberDescription": "PuÃ² generare chiavi API solo per sÃ©",
  ...
  "workspace.reload.disabled.before": "La ricarica auto Ã¨",
  "workspace.reload.disabled.state": "disabilitata",
  "workspace.reload.disabled.after": "Abilita per ricaricare automaticamente quando il saldo Ã¨ basso.",
  "workspace.reload.enabled.before": "La ricarica auto Ã¨",
  ...
  "workspace.black.subscription.message": "Sei abbonato a IaBotAhmed Black per ${{plan}} al mese.",
  ...
  "workspace.black.waitlist.joined": "Sei nella waitlist per il piano IaBotAhmed Black da ${{plan}} al mese.",
  "workspace.black.waitlist.ready": "Siamo pronti per iscriverti al piano IaBotAhmed Black da ${{plan}} al mese.",
  ...
  "workspace.black.waitlist.enrollNote":
    "Quando clicchi su Iscriviti, il tuo abbonamento inizia immediatamente e la tua carta verrÃ  addebitata.",
  ...
  "workspace.lite.subscription.message": "Sei abbonato a IaBotAhmed Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Seleziona "ia-bot-ahmed Go" come provider nella tua configurazione IaBotAhmed per utilizzare i modelli Go.',
  "workspace.lite.black.message":
    "Attualmente sei abbonato a IaBotAhmed Black o sei in lista d'attesa. Annulla l'iscrizione prima se desideri passare a Go.",
  "workspace.lite.other.message":
    "Un altro membro in questo workspace Ã¨ giÃ  abbonato a IaBotAhmed Go. Solo un membro per workspace puÃ² abbonarsi.",
  "workspace.lite.promo.description":
    "ia-bot-ahmed Go parte da {{price}}, poi $10/mese, e offre un accesso affidabile a popolari modelli di coding aperti con generosi limiti di utilizzo.",
  "workspace.lite.promo.price": "$5 il primo mese",
  "workspace.lite.promo.modelsTitle": "Cosa Ã¨ incluso",
  "workspace.lite.promo.footer":
    "Il piano Ã¨ progettato principalmente per gli utenti internazionali, con modelli ospitati in US, EU e Singapore per un accesso globale stabile. I prezzi e i limiti di utilizzo potrebbero cambiare man mano che impariamo dall'utilizzo iniziale e dal feedback.",
  ...
  "workspace.referral.overview.subtitle": "Guadagna $5 quando un amico si abbona. Anche lui riceverÃ  $5.",
  ...
  "download.meta.description": "Scarica IaBotAhmed per macOS, Windows e Linux",
  "download.hero.title": "Scarica IaBotAhmed",
  ...
  "download.section.extensions": "ia-bot-ahmed Extensions",
  "download.section.integrations": "ia-bot-ahmed Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Non necessariamente, ma probabilmente. Avrai bisogno di un abbonamento IA se vuoi collegare IaBotAhmed a un provider a pagamento, sebbene tu possa lavorare con",
  ...
  "download.faq.a3.afterZen": ", IaBotAhmed funziona con tutti i provider popolari come OpenAI, Anthropic, xAI ecc.",

  "download.faq.a5.p1": "ia-bot-ahmed Ã¨ gratuito al 100%.",
  "download.faq.a5.p2.beforeZen":
    "Eventuali costi aggiuntivi proverranno dal tuo abbonamento a un provider di modelli. Mentre IaBotAhmed funziona con qualsiasi provider di modelli, raccomandiamo di usare",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "I tuoi dati e informazioni sono archiviati solo quando crei link condivisibili in IaBotAhmed.",
  "download.faq.a6.p2.beforeShare": "Scopri di piÃ¹ sulle",
  "download.faq.a6.shareLink": "pagine condivise",

  "enterprise.title": "ia-bot-ahmed | Soluzioni Enterprise per la tua organizzazione",
  "enterprise.meta.description": "Contatta IaBotAhmed per soluzioni enterprise",
  "enterprise.hero.title": "Il tuo codice Ã¨ tuo",
  "enterprise.hero.body1":
    "ia-bot-ahmed opera in modo sicuro all'interno della tua organizzazione senza dati o contesto archiviati e senza restrizioni di licenza o rivendicazioni di proprietÃ . Inizia una prova con il tuo team, poi distribuisci attraverso la tua organizzazione integrandolo con il tuo SSO e gateway IA interno.",
  ...
  "enterprise.faq.q1": "Cos'Ã¨ IaBotAhmed Enterprise?",
  "enterprise.faq.a1":
    "ia-bot-ahmed Enterprise Ã¨ per le organizzazioni che vogliono garantire che il loro codice e dati non lascino mai la loro infrastruttura. PuÃ² farlo usando una configurazione centralizzata che si integra con il tuo SSO e gateway IA interno.",
  "enterprise.faq.q2": "Come inizio con IaBotAhmed Enterprise?",
  "enterprise.faq.a2":
    "Inizia semplicemente con una prova interna con il tuo team. IaBotAhmed per impostazione predefinita non archivia il tuo codice o dati di contesto, rendendo facile iniziare. Poi contattaci per discutere prezzi e opzioni di implementazione.",
  ...
  "enterprise.faq.q4": "I miei dati sono sicuri con IaBotAhmed Enterprise?",
  "enterprise.faq.a4":
    "SÃ¬. IaBotAhmed non archivia il tuo codice o dati di contesto. Tutto il trattamento avviene localmente o attraverso chiamate API dirette al tuo provider IA. Con configurazione centrale e integrazione SSO, i tuoi dati rimangono sicuri all'interno dell'infrastruttura della tua organizzazione.",

  "brand.title": "ia-bot-ahmed | Brand",
  "brand.meta.description": "Linee guida del brand IaBotAhmed",
  "brand.heading": "Linee guida del brand",
  "brand.subtitle": "Risorse e asset per aiutarti a lavorare con il brand IaBotAhmed.",
  "brand.downloadAll": "Scarica tutti gli asset",

  "changelog.title": "ia-bot-ahmed | Changelog",
  "changelog.meta.description": "Note di rilascio e changelog IaBotAhmed",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nuovi aggiornamenti e miglioramenti a IaBotAhmed",
  ...
  "bench.detail.labels.penalty": "PenalitÃ ",
  "bench.detail.labels.weight": "peso",
  "bench.detail.table.run": "Esecuzione",
  "bench.detail.table.score": "Punteggio (Base - PenalitÃ )",
