...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new ia-bot-ahmedClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the ia-bot-ahmed system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the ia-bot-ahmed system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the ia-bot-ahmed server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local ia-bot-ahmed state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global ia-bot-ahmed configuration settings and preferences.
   */
   ...
   *
   * Update global ia-bot-ahmed configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the ia-bot-ahmed server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the ia-bot-ahmed system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all ia-bot-ahmed instances, releasing all resources.
   */
  ...
  /**
   * Upgrade ia-bot-ahmed
   *
   * Upgrade ia-bot-ahmed to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current ia-bot-ahmed configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update ia-bot-ahmed configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current ia-bot-ahmed instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the ia-bot-ahmed system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with ia-bot-ahmed.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that ia-bot-ahmed is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by ia-bot-ahmed.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all ia-bot-ahmed sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new ia-bot-ahmed session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific ia-bot-ahmed session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class ia-bot-ahmedClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<ia-bot-ahmedClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    ia-bot-ahmedClient.__registry.set(this, args?.key)
  }
