...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new IaBotAhmedClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the IaBotAhmed system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the IaBotAhmed system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the IaBotAhmed server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local IaBotAhmed state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global IaBotAhmed configuration settings and preferences.
   */
   ...
   *
   * Update global IaBotAhmed configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the IaBotAhmed server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the IaBotAhmed system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all IaBotAhmed instances, releasing all resources.
   */
   ...
   * Upgrade IaBotAhmed
   *
   * Upgrade IaBotAhmed to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current IaBotAhmed configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update IaBotAhmed configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current IaBotAhmed instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the IaBotAhmed system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with IaBotAhmed.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that IaBotAhmed is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by IaBotAhmed.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all IaBotAhmed sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new IaBotAhmed session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific IaBotAhmed session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class IaBotAhmedClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<IaBotAhmedClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    IaBotAhmedClient.__registry.set(this, args?.key)
  }
