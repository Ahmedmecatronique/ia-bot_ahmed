...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  const issueURL = new URL("https://github.com/anomalyco/ia-bot-ahmed/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("ia-bot-ahmed-version", InstallationVersion)
