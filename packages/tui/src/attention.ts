...
import defaultSoundPath from "@ia-bot-ahmed/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@ia-bot-ahmed/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@ia-bot-ahmed/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@ia-bot-ahmed/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@ia-bot-ahmed/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@ia-bot-ahmed/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "ia-bot-ahmed"
const DEFAULT_PACK_ID = "ia-bot-ahmed.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "ia-bot-ahmed Default",
  builtin: true,
  sounds: {
