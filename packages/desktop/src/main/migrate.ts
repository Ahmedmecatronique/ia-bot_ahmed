...
// `ia-bot-ahmed.settings.dat` is special: it maps to the `ia-bot-ahmed.settings` store
...
// renderer already passes via IPC (e.g. `"default.dat"`, `"ia-bot-ahmed.global.dat"`).
