export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of IaBotAhmed",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of IaBotAhmed has been downloaded, would you like to install it and relaunch?",
