export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの ia-bot-ahmed を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "ia-bot-ahmed のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'ia-bot-ahmed' コマンドを使用してください。",
