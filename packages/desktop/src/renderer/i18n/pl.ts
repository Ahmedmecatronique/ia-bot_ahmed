export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji ia-bot-ahmed",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} ia-bot-ahmed. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'ia-bot-ahmed'.",
