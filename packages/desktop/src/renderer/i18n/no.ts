export const dict = {
  ...
  "desktop.menu.reloadWebview": "Last inn Webview p̴ nytt",
  "desktop.menu.restart": "Start p̴ nytt",
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av IaBotAhmed",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av IaBotAhmed er lastet ned. Vil du installere den og starte p̴ nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen p̴ nytt for ̴ bruke 'ia-bot-ahmed'-kommandoen.",
