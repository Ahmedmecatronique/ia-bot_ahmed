export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من ia-bot-ahmed",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من ia-bot-ahmed، هل ترغب في تثبيته وإعادة تشغيله؟",
