...
const getBase = (appId: string): Configuration => ({
  artifactName: "ia-bot-ahmed-desktop-${os}-${arch}.${ext}",
  directories: {
    output: "dist",
  ...
  switch (channel) {
    case "dev": {
      return {
        ...base,
        appId,
        productName: "ia-bot-ahmed Dev",
        rpm: { packageName: "ia-bot-ahmed-dev" },
      }
    }
    case "beta": {
      return {
        ...base,
        appId,
        productName: "ia-bot-ahmed Beta",
        protocols: { name: "ia-bot-ahmed Beta", schemes: ["ia-bot-ahmed"] },
        publish: { provider: "github", owner: "anomalyco", repo: "ia-bot-ahmed-beta", channel: "latest" },
        rpm: { packageName: "ia-bot-ahmed-beta" },
      }
    }
    case "prod": {
      return {
        ...base,
        appId,
        productName: "ia-bot-ahmed",
        protocols: { name: "ia-bot-ahmed", schemes: ["ia-bot-ahmed"] },
        publish: { provider: "github", owner: "anomalyco", repo: "ia-bot-ahmed", channel: "latest" },
        deb: { fpm: [legacyDesktopEntryFpm] },
        rpm: { packageName: "ia-bot-ahmed", fpm: [legacyDesktopEntryFpm] },
      }
    }
  }
}
