...
const releaseId = process.env.IA_BOT_AHMED_RELEASE
if (!releaseId) throw new Error("IA_BOT_AHMED_RELEASE is required")

const version = process.env.IA_BOT_AHMED_VERSION
if (!version) throw new Error("IA_BOT_AHMED_VERSION is required")
...
const macxTarGz = "ia-bot-ahmed-desktop-mac-x64.app.tar.gz"
const macaTarGz = "ia-bot-ahmed-desktop-mac-arm64.app.tar.gz"
