...
import type * as SDK from "@ia-bot-ahmed/sdk/v2"
...
import { SessionShareTable } from "@ia-bot-ahmed/core/share/sql"
...
const disabled = process.env["IA_BOT_AHMED_DISABLE_SHARE"] === "true" || process.env["IA_BOT_AHMED_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/ShareNext") {}
