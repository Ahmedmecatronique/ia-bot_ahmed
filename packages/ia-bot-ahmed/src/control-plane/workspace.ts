...
import { EventSequenceTable, EventTable } from "@ia-bot-ahmed/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        IA_BOT_AHMED_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        IA_BOT_AHMED_WORKSPACE_ID: config.id,
        IA_BOT_AHMED_EXPERIMENTAL_WORKSPACES: "true",
