...
import { normalizePromptContent } from "@ia-bot-ahmed/tui/editor"
...
import { IA_BOT_AHMED_BASE_MODE, useBindings } from "@ia-bot-ahmed/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close ia-bot-ahmed" } satisfies SlashOption,
    ]
