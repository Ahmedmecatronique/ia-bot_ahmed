...
//
// Enable with IA_BOT_AHMED_DIRECT_TRACE=1. Writes one JSON line per event to
// ~/.local/share/ia-bot-ahmed/log/direct/<timestamp>-<pid>.jsonl. Also writes
...
export function trace(): Trace | undefined {
  ...
  if (!process.env.IA_BOT_AHMED_DIRECT_TRACE) {
    state = false
    return undefined
  }
