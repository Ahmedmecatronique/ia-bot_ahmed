...
//
// The saved variant persists across sessions in ~/.local/state/ia-bot-ahmed/model.json
...
class Service extends Context.Service<Service, VariantService>()("@ia-bot-ahmed/RunVariant") {}
