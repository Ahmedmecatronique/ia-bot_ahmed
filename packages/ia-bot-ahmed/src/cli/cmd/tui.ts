...
import { win32InstallCtrlCGuard } from "@ia-bot-ahmed/tui/terminal-win32"

declare global {
  const IA_BOT_AHMED_WORKER_PATH: string
}
...
async function target() {
  if (typeof IA_BOT_AHMED_WORKER_PATH !== "undefined") return IA_BOT_AHMED_WORKER_PATH
