...
import { ProjectDirectoryTable, ProjectTable } from "@ia-bot-ahmed/core/project/sql"
import { ProjectDirectories } from "@ia-bot-ahmed/core/project/directories"
...
import { which } from "@ia-bot-ahmed/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@ia-bot-ahmed/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.IA_BOT_AHMED_FAKE_VCS)
