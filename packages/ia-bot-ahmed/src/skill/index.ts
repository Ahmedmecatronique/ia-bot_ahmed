...
import { FrontmatterError } from "@ia-bot-ahmed/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@ia-bot-ahmed/core/util/glob"
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, IA_BOT_AHMED_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_IA_BOT_AHMED_SKILL_NAME] = {
          name: CUSTOMIZE_IA_BOT_AHMED_SKILL_NAME,
          description: CUSTOMIZE_IA_BOT_AHMED_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_IA_BOT_AHMED_SKILL_BODY,
        }
