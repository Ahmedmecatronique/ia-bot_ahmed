...
import { httpClient, path } from "@ia-bot-ahmed/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/SkillDiscovery") {}
