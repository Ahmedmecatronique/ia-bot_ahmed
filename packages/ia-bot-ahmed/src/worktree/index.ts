...
import { path } from "@ia-bot-ahmed/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@ia-bot-ahmed/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `ia-bot-ahmed/${name}`
