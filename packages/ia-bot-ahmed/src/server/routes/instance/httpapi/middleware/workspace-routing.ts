...
>()("@ia-bot-ahmed/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@ia-bot-ahmed/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.IA_BOT_AHMED_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.IA_BOT_AHMED_WORKSPACE_ID) : undefined
}
