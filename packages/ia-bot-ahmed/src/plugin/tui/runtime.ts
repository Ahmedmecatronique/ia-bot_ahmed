...
import {
  ...
  type TuiSlotPlugin,
  type TuiTheme,
} from "@ia-bot-ahmed/plugin/tui"
import path from "path"
import { fileURLToPath } from "url"
import { TuiConfig } from "@/config/tui"
import { errorData, errorMessage } from "@ia-bot-ahmed/tui/util/error"
import { isRecord } from "@ia-bot-ahmed/tui/util/record"
...
import { hasTheme, upsertTheme } from "@ia-bot-ahmed/tui/context/theme"
import { Global } from "@ia-bot-ahmed/core/global"
import { Filesystem } from "@/util/filesystem"
import { Process } from "@/util/process"
import { Flock } from "@ia-bot-ahmed/core/util/flock"
import { Flag } from "@ia-bot-ahmed/core/flag/flag"
import { internalTuiPlugins, type InternalTuiPlugin } from "./internal"
import type { HostPluginApi, HostSlots } from "@ia-bot-ahmed/tui/plugin/slots"
import { ConfigPlugin } from "@/config/plugin"
import { ConfigPluginV1 } from "@ia-bot-ahmed/core/v1/config/plugin"
import { createCommandShim } from "@ia-bot-ahmed/tui/plugin/command-shim"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Effect } from "effect"
import { createPluginRuntime, type PluginRuntime, type TuiPluginHost } from "@ia-bot-ahmed/tui/plugin/runtime"
...
async function load(input: {
  ...
  try {
    ...
    const records = Flag.IA_BOT_AHMED_PURE ? [] : pluginOrigins
    if (Flag.IA_BOT_AHMED_PURE && pluginOrigins.length) {
    }
