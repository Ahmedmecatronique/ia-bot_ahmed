...
<html>
  <head><title>ia-bot-ahmed - Snowflake Authorization Successful</title></head>
...
<html>
  <head><title>ia-bot-ahmed - Snowflake Authorization Failed</title></head>
  <body style="font-family: system-ui; display:flex; align-items:center; justify-content:center; height:100vh; margin:0; background:#111; color:#eee;">
        ...
        return {
          ...
          async fetch(requestInput: RequestInfo | URL, init?: RequestInit) {
            ...
            const prepareRequest = () => {
              ...
              headers.set("User-Agent", `ia-bot-ahmed/${InstallationVersion}`)
      ...
      methods: [
        {
          ...
          async authorize(inputs = {}) {
            ...
            return {
              url,
              instructions:
                "Complete Snowflake sign-in in your browser. ia-bot-ahmed will capture the OAuth callback and store the bearer token automatically.",
