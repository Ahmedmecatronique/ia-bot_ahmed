...
import type { LLMEvent } from "@ia-bot-ahmed/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@ia-bot-ahmed/llm/route"
import type { LLMClientService } from "@ia-bot-ahmed/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @ia-bot-ahmed/llm. It
