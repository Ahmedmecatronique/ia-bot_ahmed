...
import { ToolOutput, Usage, type LLMEvent } from "@ia-bot-ahmed/llm"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/SessionProcessor") {}
