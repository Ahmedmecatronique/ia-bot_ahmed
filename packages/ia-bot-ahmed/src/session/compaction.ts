...
import { buildPrompt } from "@ia-bot-ahmed/core/session/compaction"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/SessionCompaction") {}
