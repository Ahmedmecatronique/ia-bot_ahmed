...
import { TuiKeybind } from "@ia-bot-ahmed/tui/config/keybind"
...
import { TuiConfig } from "@ia-bot-ahmed/tui/config"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/TuiConfig") {}
...
const loadState = Effect.fn("TuiConfig.loadState")(function* (ctx: { directory: string }) {
  ...
  const projectFiles = Flag.IA_BOT_AHMED_DISABLE_PROJECT_CONFIG ? [] : yield* ConfigPaths.files("tui", ctx.directory)
  ...
  // 2. Explicit IA_BOT_AHMED_TUI_CONFIG override, if set.
  if (Flag.IA_BOT_AHMED_TUI_CONFIG) {
    const configFile = Flag.IA_BOT_AHMED_TUI_CONFIG
