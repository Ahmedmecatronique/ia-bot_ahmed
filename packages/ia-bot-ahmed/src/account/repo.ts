...
import { AccountStateTable, AccountTable } from "@ia-bot-ahmed/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/AccountRepo") {}
