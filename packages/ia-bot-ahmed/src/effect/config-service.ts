 ...
 *   "@ia-bot-ahmed/ServerAuthConfig",
 *   {
 *     password: Config.string("IA_BOT_AHMED_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("IA_BOT_AHMED_SERVER_USERNAME").pipe(Config.withDefault("ia-bot-ahmed")),
 *   },
 * ) {}
 *
