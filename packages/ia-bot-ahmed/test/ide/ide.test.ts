...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders IA_BOT_AHMED_CALLER", () => {
    process.env["IA_BOT_AHMED_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode IA_BOT_AHMED_CALLER", () => {
    process.env["IA_BOT_AHMED_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown IA_BOT_AHMED_CALLER", () => {
    process.env["IA_BOT_AHMED_CALLER"] = "unknown"
