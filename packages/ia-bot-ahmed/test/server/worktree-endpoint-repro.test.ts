...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      IA_BOT_AHMED_EXPERIMENTAL_WORKSPACES: Flag.IA_BOT_AHMED_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.IA_BOT_AHMED_EXPERIMENTAL_WORKSPACES = original.IA_BOT_AHMED_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
