...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/ia-bot-ahmed`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy ia-bot-ahmed service removed
