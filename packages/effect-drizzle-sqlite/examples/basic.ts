...
class Database extends Context.Service<Database, DatabaseShape>()("@ia-bot-ahmed/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@ia-bot-ahmed/example/UserStore") {
