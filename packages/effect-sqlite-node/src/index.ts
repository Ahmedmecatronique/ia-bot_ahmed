...
export const TypeId: TypeId = "~@ia-bot-ahmed/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@ia-bot-ahmed/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@ia-bot-ahmed/effect-sqlite-node/NodeSqliteClient")
