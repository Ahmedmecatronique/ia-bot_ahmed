...
import {
  ...
  type StatsModelData,
  type UsageRange,
} from "@ia-bot-ahmed/stats-core/domain/home"
...
export default function StatsModel() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="ia-bot-ahmed" />
...
function ModelGeoBreakdownSection(props: { data: Record<UsageRange, CountryEntry[]> }) {
  ...
  return (
    ...
    >
      <SectionTitle title="Geo Breakdown" description="ia-bot-ahmed Go model tokens used by country." />
      <Show
        when={data().length > 0}
        fallback={
