...
const directory = "C:/ia-bot-ahmed/SmokeProject"
const projectID = "proj_smoke_timeline"
const model = { providerID: "ia-bot-ahmed", modelID: "claude-opus-4-6", variant: "max" }
...
export const fixture = {
  ...
  provider: {
    ...
    connected: ["ia-bot-ahmed"],
    default: { providerID: "ia-bot-ahmed", modelID: "claude-opus-4-6" },
  },
  sessions: [
    {
      id: sourceID,
