...
import { Tooltip, TooltipKeybind } from "@ia-bot-ahmed/ui/tooltip"
import { useTheme } from "@ia-bot-ahmed/ui/theme/context"
import { IconButtonV2 } from "@ia-bot-ahmed/ui/v2/icon-button-v2"
import { Icon as IconV2 } from "@ia-bot-ahmed/ui/v2/icon"
import { KeybindV2 } from "@ia-bot-ahmed/ui/v2/keybind-v2"
import { TooltipV2 } from "@ia-bot-ahmed/ui/v2/tooltip-v2"
...
import { ProjectAvatar } from "@ia-bot-ahmed/ui/v2/project-avatar-v2"
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="ia-bot-ahmed-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                    <ChannelIndicator />
                  </div>
                </div>
              </div>
            ...
            <div class="min-w-0 flex items-center justify-center pointer-events-none">
              <div
                id="ia-bot-ahmed-titlebar-center"
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="ia-bot-ahmed-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="ia-bot-ahmed-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_IA_BOT_AHMED_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_IA_BOT_AHMED_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
