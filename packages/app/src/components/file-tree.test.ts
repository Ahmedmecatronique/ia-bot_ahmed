...
beforeAll(async () => {
  ...
  mock.module("@ia-bot-ahmed/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@ia-bot-ahmed/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@ia-bot-ahmed/ui/icon", () => ({ Icon: () => null }))
  mock.module("@ia-bot-ahmed/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
