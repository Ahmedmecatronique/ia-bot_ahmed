...
const GLOBAL_STORAGE = "ia-bot-ahmed.global.dat"
const LOCAL_PREFIX = "ia-bot-ahmed."
...
function workspaceStorage(dir: string) {
  ...
  return `ia-bot-ahmed.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `ia-bot-ahmed.draft.${head}.${sum}.dat`
}
