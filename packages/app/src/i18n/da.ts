export const dict = {
  ...
  "dialog.provider.ia-bot-ahmed.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.ia-bot-ahmed.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.ia-bot-ahmedGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af ia-bot-ahmed",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i ia-bot-ahmed.",
  ...
  "provider.connect.ia-bot-ahmedZen.line1":
    "ia-bot-ahmed Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.ia-bot-ahmedZen.visit.prefix": "Besøg ",
  "provider.connect.ia-bot-ahmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.ia-bot-ahmedZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i ia-bot-ahmed.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i ia-bot-ahmed.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i ia-bot-ahmed.json",
  ...
  "dialog.server.description": "Skift hvilken ia-bot-ahmed-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af ia-bot-ahmed ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til ia-bot-ahmed-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (ia-bot-ahmed.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, ia-bot-ahmed understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "ia-bot-ahmed inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør ia-bot-ahmed-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for ia-bot-ahmed",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan ia-bot-ahmed ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om ia-bot-ahmed følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan ia-bot-ahmed er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når ia-bot-ahmed starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af ia-bot-ahmed.",
