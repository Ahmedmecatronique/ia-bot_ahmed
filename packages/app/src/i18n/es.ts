export const dict = {
  ...
  "dialog.provider.IaBotAhmed.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y mÃ¡s",
  "dialog.provider.IaBotAhmed.tagline": "Modelos optimizados y fiables",
  "dialog.provider.IaBotAhmedGo.tagline": "SuscripciÃ³n econÃ³mica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por IaBotAhmed",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en IaBotAhmed.",
  ...
  "provider.connect.IaBotAhmedZen.line1":
    "ia-bot-ahmed Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programaciÃ³n.",
  "provider.connect.IaBotAhmedZen.line2":
    "Con una sola clave API obtendrÃ¡s acceso a modelos como Claude, GPT, Gemini, GLM y mÃ¡s.",
  "provider.connect.IaBotAhmedZen.visit.prefix": "Visita ",
  "provider.connect.IaBotAhmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.IaBotAhmedZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu cÃ³digo de autorizaciÃ³n para conectar tu cuenta y usar modelos de {{provider}} en IaBotAhmed.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el cÃ³digo a continuaciÃ³n para conectar tu cuenta y usar modelos de {{provider}} en IaBotAhmed.",
  ...
  "dialog.plugins.empty": "Plugins configurados en IaBotAhmed.json",
  ...
  "dialog.server.description": "Cambiar a quÃ© servidor de IaBotAhmed se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versiÃ³n de IaBotAhmed ({{version}}) estÃ¡ disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de IaBotAhmed",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuraciÃ³n (IaBotAhmed.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" fallÃ³. Nota, IaBotAhmed no soporta autenticaciÃ³n MCP todavÃ­a.',
  ...
  "sidebar.gettingStarted.line1": "ia-bot-ahmed incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor IaBotAhmed dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualizaciÃ³n para IaBotAhmed",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cÃ³mo se ve IaBotAhmed en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si IaBotAhmed sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de IaBotAhmed.",
  ...
  "settings.general.row.showSessionProgressBar.title": "Mostrar barra de progreso de la sesiÃ³n",
  "settings.general.row.showSessionProgressBar.description":
    "Mostrar la barra de progreso animada en la parte superior de la sesiÃ³n cuando el agente estÃ© trabajando",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automÃ¡ticamente cuando se inicia IaBotAhmed",
  ...
  "settings.updates.toast.latest.description": "EstÃ¡s usando la Ãºltima versiÃ³n de IaBotAhmed.",
