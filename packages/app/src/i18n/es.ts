export const dict = {
  ...
  "dialog.provider.ia-bot-ahmed.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.ia-bot-ahmed.tagline": "Modelos optimizados y fiables",
  "dialog.provider.ia-bot-ahmedGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por ia-bot-ahmed",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en ia-bot-ahmed.",
  ...
  "provider.connect.ia-bot-ahmedZen.line1":
    "ia-bot-ahmed Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.ia-bot-ahmedZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.ia-bot-ahmedZen.visit.prefix": "Visita ",
  "provider.connect.ia-bot-ahmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.ia-bot-ahmedZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en ia-bot-ahmed.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en ia-bot-ahmed.",
  ...
  "dialog.plugins.empty": "Plugins configurados en ia-bot-ahmed.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de ia-bot-ahmed se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de ia-bot-ahmed ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de ia-bot-ahmed",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (ia-bot-ahmed.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, ia-bot-ahmed no soporta autenticación MCP todavía.',
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor ia-bot-ahmed dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para ia-bot-ahmed",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve ia-bot-ahmed en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si ia-bot-ahmed sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de ia-bot-ahmed.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia ia-bot-ahmed",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de ia-bot-ahmed.",
