...
export const dict = {
  ...
  "dialog.provider.IaBotAhmed.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.IaBotAhmed.tagline": "PÃ¥litelige, optimaliserte modeller",
  "dialog.provider.IaBotAhmedGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av IaBotAhmed",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nÃ¸kkel for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i IaBotAhmed.",
  ...
  "provider.connect.IaBotAhmedZen.line1":
    "ia-bot-ahmed Zen gir deg tilgang til et utvalg av pÃ¥litelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.IaBotAhmedZen.visit.prefix": "BesÃ¸k ",
  "provider.connect.IaBotAhmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.IaBotAhmedZen.visit.suffix": " for Ã¥ hente API-nÃ¸kkelen din.",
  "provider.connect.oauth.code.visit.prefix": "BesÃ¸k ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for Ã¥ hente autorisasjonskoden din for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i IaBotAhmed.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i IaBotAhmed.",
  ...
  "prompt.toast.pasteUnsupported.title": "Ikke stÃ¸ttet vedlegg",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i IaBotAhmed.json",

  "mcp.status.connected": "tilkoblet",
  "mcp.status.failed": "mislyktes",
  "mcp.status.needs_auth": "trenger autentisering",
  "mcp.auth.clickToAuthenticate": "Klikk for Ã¥ autentisere",
  ...
  "dialog.server.description": "Bytt hvilken IaBotAhmed-server denne appen kobler til.",
  ...
  "dialog.project.edit.worktree.startup": "Oppstartsskript for arbeidsomrÃ¥de",
  "dialog.project.edit.worktree.startup.description": "KjÃ¸rer etter at et nytt arbeidsomrÃ¥de (worktree) er opprettet.",
  ...
  "toast.workspace.enabled.description": "Flere worktrees vises nÃ¥ i sidefeltet",
  ...
  "toast.update.description": "En ny versjon av IaBotAhmed ({{version}}) er nÃ¥ tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til IaBotAhmed-teamet",
  ...
  "error.serverSync.connectFailed": "Kunne ikke koble til server. KjÃ¸rer det en server pÃ¥ `{{url}}`?",
  ...
  "error.chain.checkConfig": "Sjekk leverandÃ¸r-/modellnavnene i konfigurasjonen din (IaBotAhmed.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at IaBotAhmed ikke stÃ¸tter MCP-autentisering ennÃ¥.',
  ...
  "session.review.noSnapshot":
    "Snapshot-sporing er deaktivert i konfigurasjonen, sÃ¥ sesjonsendringer er ikke tilgjengelige",
  ...
  "session.followupDock.summary.one": "{{count}} melding i kÃ¸",
  "session.followupDock.summary.other": "{{count}} meldinger i kÃ¸",
  "session.followupDock.sendNow": "Send nÃ¥",
  "session.followupDock.edit": "Rediger",
  "session.followupDock.collapse": "Skjul meldinger i kÃ¸",
  "session.followupDock.expand": "Utvid meldinger i kÃ¸",
  ...
  "sidebar.gettingStarted.line1": "ia-bot-ahmed inkluderer gratis modeller sÃ¥ du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "KjÃ¸r IaBotAhmed-serveren i WSL pÃ¥ Windows.",
  ...
  "settings.general.row.language.description": "Endre visningssprÃ¥ket for IaBotAhmed",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan IaBotAhmed ser ut pÃ¥ enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om IaBotAhmed skal fÃ¸lge systemets, lyst eller mÃ¸rkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan IaBotAhmed er tematisert.",
  ...
  "settings.general.row.followup.title": "OppfÃ¸lgingsadferd",
  "settings.general.row.followup.description": "Velg om oppfÃ¸lgingsspÃ¸rsmÃ¥l skal kjÃ¸res umiddelbart eller vente i kÃ¸",
  ...
  "settings.general.row.showSessionProgressBar.description":
    "Vis den animerte fremdriftslinjen Ã¸verst i sesjonen nÃ¥r agenten jobber",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer nÃ¥r IaBotAhmed starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av IaBotAhmed.",
  ...
  "app.server.retrying": "PrÃ¸ver pÃ¥ nytt automatisk...",
  ...
  "session.review.noVcs.createGit.description": "Spor, gjennomgÃ¥ og angre endringer i dette prosjektet",
  "session.review.noVcs.createGit.actionLoading": "Oppretter Git-depot...",
  "session.review.noVcs.createGit.action": "Opprett Git-depot",
  "session.todo.progress": "{{done}} av {{total}} oppgaver fullfÃ¸rt",
  "session.question.progress": "{{current}} av {{total}} spÃ¸rsmÃ¥l",
  ...
  "debugBar.nav.tip":
    "Siste fullfÃ¸rte ruteovergang som berÃ¸rer en sesjonsside, mÃ¥lt fra ruterstart til fÃ¸rste opptegning etter at den har roet seg.",
