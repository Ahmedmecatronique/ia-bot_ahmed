...
export const dict = {
  ...
  "dialog.provider.ia-bot-ahmed.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.ia-bot-ahmed.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.ia-bot-ahmedGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av ia-bot-ahmed",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i ia-bot-ahmed.",
  ...
  "provider.connect.ia-bot-ahmedZen.line1":
    "ia-bot-ahmed Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.ia-bot-ahmedZen.visit.prefix": "Besøk ",
  "provider.connect.ia-bot-ahmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.ia-bot-ahmedZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i ia-bot-ahmed.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i ia-bot-ahmed.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i ia-bot-ahmed.json",
  ...
  "dialog.server.description": "Bytt hvilken ia-bot-ahmed-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av ia-bot-ahmed ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til ia-bot-ahmed-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (ia-bot-ahmed.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at ia-bot-ahmed ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "ia-bot-ahmed inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør ia-bot-ahmed-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for ia-bot-ahmed",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan ia-bot-ahmed ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om ia-bot-ahmed skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan ia-bot-ahmed er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når ia-bot-ahmed starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av ia-bot-ahmed.",
