export const dict = {
  ...
  "dialog.provider.ia-bot-ahmed.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.ia-bot-ahmed.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.ia-bot-ahmedGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez ia-bot-ahmed",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w ia-bot-ahmed.",
  ...
  "provider.connect.ia-bot-ahmedZen.line1":
    "ia-bot-ahmed Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.ia-bot-ahmedZen.visit.prefix": "Odwiedź ",
  "provider.connect.ia-bot-ahmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.ia-bot-ahmedZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w ia-bot-ahmed.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w ia-bot-ahmed.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w ia-bot-ahmed.json",
  ...
  "dialog.server.description": "Przełącz serwer ia-bot-ahmed, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja ia-bot-ahmed ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu ia-bot-ahmed",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (ia-bot-ahmed.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "ia-bot-ahmed zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla ia-bot-ahmed",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd ia-bot-ahmed na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy ia-bot-ahmed ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw ia-bot-ahmed.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania ia-bot-ahmed",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji ia-bot-ahmed.",
