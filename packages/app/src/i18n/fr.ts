export const dict = {
  ...
  "dialog.provider.ia-bot-ahmed.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.ia-bot-ahmed.tagline": "Modèles optimisés et fiables",
  "dialog.provider.ia-bot-ahmedGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par ia-bot-ahmed",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans ia-bot-ahmed.",
  ...
  "provider.connect.ia-bot-ahmedZen.line1":
    "ia-bot-ahmed Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.ia-bot-ahmedZen.visit.prefix": "Visitez ",
  "provider.connect.ia-bot-ahmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.ia-bot-ahmedZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans ia-bot-ahmed.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans ia-bot-ahmed.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans ia-bot-ahmed.json",
  ...
  "dialog.server.description": "Changez le serveur ia-bot-ahmed auquel cette application se connecte.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe ia-bot-ahmed",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (ia-bot-ahmed.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'ia-bot-ahmed ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "ia-bot-ahmed inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur ia-bot-ahmed dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour ia-bot-ahmed",
  ...
  "settings.general.row.colorScheme.description": "Choisissez si ia-bot-ahmed suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'ia-bot-ahmed.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'ia-bot-ahmed",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'ia-bot-ahmed.",
