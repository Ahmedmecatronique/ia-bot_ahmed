...
export const dict = {
  ...
  "dialog.provider.ia-bot-ahmed.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.ia-bot-ahmed.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.ia-bot-ahmedGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "ia-bot-ahmed tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve ia-bot-ahmed'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.ia-bot-ahmedZen.line1":
    "ia-bot-ahmed Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.ia-bot-ahmedZen.visit.prefix": "",
  "provider.connect.ia-bot-ahmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.ia-bot-ahmedZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve ia-bot-ahmed'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak ia-bot-ahmed'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler ia-bot-ahmed.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi ia-bot-ahmed sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "ia-bot-ahmed'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı ia-bot-ahmed ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (ia-bot-ahmed.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: ia-bot-ahmed henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "ia-bot-ahmed ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "ia-bot-ahmed Masaüstü",
  ...
  "settings.desktop.wsl.description": "ia-bot-ahmed sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "ia-bot-ahmed'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "ia-bot-ahmed'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "ia-bot-ahmed'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "ia-bot-ahmed'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "ia-bot-ahmed başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "ia-bot-ahmed'un en son sürümünü kullanıyorsunuz.",
