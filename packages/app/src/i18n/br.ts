export const dict = {
  ...
  "dialog.provider.ia-bot-ahmed.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.ia-bot-ahmed.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.ia-bot-ahmedGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo ia-bot-ahmed",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no ia-bot-ahmed.",
  ...
  "provider.connect.ia-bot-ahmedZen.line1":
    "ia-bot-ahmed Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.ia-bot-ahmedZen.visit.prefix": "Visite ",
  "provider.connect.ia-bot-ahmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.ia-bot-ahmedZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no ia-bot-ahmed.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no ia-bot-ahmed.",
  ...
  "dialog.plugins.empty": "Plugins configurados em ia-bot-ahmed.json",
  ...
  "dialog.server.description": "Trocar para qual servidor ia-bot-ahmed este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do ia-bot-ahmed ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do ia-bot-ahmed",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (ia-bot-ahmed.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: ia-bot-ahmed ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "ia-bot-ahmed inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor ia-bot-ahmed dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do ia-bot-ahmed",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o ia-bot-ahmed aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o ia-bot-ahmed segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o ia-bot-ahmed é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o ia-bot-ahmed iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do ia-bot-ahmed.",
