export const dict = {
  ...
  "dialog.provider.ia-bot-ahmed.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.ia-bot-ahmed.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.ia-bot-ahmedGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje ia-bot-ahmed",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u ia-bot-ahmed-u.",
  ...
  "provider.connect.ia-bot-ahmedZen.visit.prefix": "Posjeti ",
  "provider.connect.ia-bot-ahmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.ia-bot-ahmedZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u ia-bot-ahmed-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u ia-bot-ahmed-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u ia-bot-ahmed.json",
  ...
  "dialog.server.description": "Promijeni na koji se ia-bot-ahmed server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija ia-bot-ahmed-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku ia-bot-ahmed timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (ia-bot-ahmed.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: ia-bot-ahmed još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "ia-bot-ahmed uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni ia-bot-ahmed server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u ia-bot-ahmed-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako ia-bot-ahmed izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li ia-bot-ahmed prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu ia-bot-ahmed-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se ia-bot-ahmed pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju ia-bot-ahmed-a.",
