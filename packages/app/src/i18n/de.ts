...
export const dict = {
  ...
  "command.session.fork.description": "Neue Sitzung aus einer frÃ¼heren Nachricht erstellen",
  ...
  "dialog.provider.IaBotAhmed.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.IaBotAhmed.tagline": "ZuverlÃ¤ssige, optimierte Modelle",
  "dialog.provider.IaBotAhmedGo.tagline": "KostengÃ¼nstiges Abo fÃ¼r alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von IaBotAhmed",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-SchlÃ¼ssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in IaBotAhmed zu nutzen.",
  ...
  "provider.connect.IaBotAhmedZen.line1":
    "ia-bot-ahmed Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlÃ¤ssiger, optimierter Modelle fÃ¼r Coding-Agenten.",
  ...
  "provider.connect.IaBotAhmedZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.IaBotAhmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.IaBotAhmedZen.visit.suffix": ", um Ihren API-SchlÃ¼ssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in IaBotAhmed zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in IaBotAhmed zu nutzen.",
  ...
  "prompt.toast.pasteUnsupported.title": "Nicht unterstÃ¼tzter Anhang",
  "prompt.toast.pasteUnsupported.description": "Hier kÃ¶nnen nur Bilder, PDFs oder Textdateien angehÃ¤ngt werden.",
  ...
  "dialog.plugins.empty": "In IaBotAhmed.json konfigurierte Plugins",
  ...
  "dialog.directory.action.selectFile": "Datei auswÃ¤hlen",
  "dialog.directory.action.selectFolder": "Ordner auswÃ¤hlen",
  "dialog.directory.root": "Stammverzeichnis",
  "dialog.directory.parent": "Ãœbergeordnet",
  "dialog.directory.readError": "Dieser Ordner kann nicht gelesen werden",
  "dialog.server.title": "Server",
  "dialog.server.description": "Wechseln Sie den IaBotAhmed-Server, mit dem sich diese App verbindet.",
  ...
  "dialog.project.edit.worktree.startup": "Startup-Skript fÃ¼r Arbeitsbereich",
  "dialog.project.edit.worktree.startup.description":
    "Wird nach dem Erstellen eines neuen Arbeitsbereichs (Worktree) ausgefÃ¼hrt.",
  ...
  "toast.update.description": "Eine neue Version von IaBotAhmed ({{version}}) ist zur Installation verfÃ¼gbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem IaBotAhmed-Team",
  ...
  "error.serverSync.connectFailed": "Verbindung zum Server fehlgeschlagen. LÃ¤uft ein Server unter `{{url}}`?",
  ...
  "error.chain.checkConfig": "ÃœberprÃ¼fen Sie Ihre Konfiguration (IaBotAhmed.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: IaBotAhmed unterstÃ¼tzt noch keine MCP-Authentifizierung.',
  ...
  "session.review.noVcs": "Kein Git-Versionskontrollsystem erkannt, Ã„nderungen werden nicht angezeigt",
  "session.review.noSnapshot":
    "Snapshot-Tracking ist in der Konfiguration deaktiviert, daher sind SitzungsÃ¤nderungen nicht verfÃ¼gbar",
  ...
  "session.revertDock.summary.one": "{{count}} zurÃ¼ckgesetzte Nachricht",
  "session.revertDock.summary.other": "{{count}} zurÃ¼ckgesetzte Nachrichten",
  "session.revertDock.collapse": "ZurÃ¼ckgesetzte Nachrichten einklappen",
  "session.revertDock.expand": "ZurÃ¼ckgesetzte Nachrichten ausklappen",
  ...
  "sidebar.gettingStarted.line1": "ia-bot-ahmed enthÃ¤lt kostenlose Modelle, damit Sie sofort loslegen kÃ¶nnen.",
  ...
  "settings.desktop.wsl.description": "ia-bot-ahmed-Server innerhalb von WSL unter Windows ausfÃ¼hren.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache fÃ¼r IaBotAhmed Ã¤ndern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie IaBotAhmed auf Ihrem GerÃ¤t aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "WÃ¤hlen Sie, ob IaBotAhmed dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von IaBotAhmed anpassen.",
  "settings.general.row.font.title": "Code-Schriftart",
  "settings.general.row.font.description": "Die in CodeblÃ¶cken verwendete Schriftart anpassen",
  ...
  "settings.general.row.followup.description":
    "WÃ¤hlen Sie, ob Folgefragen sofort steuern oder in einer Warteschlange warten",
  ...
  "settings.updates.row.startup.description": "Beim Start von IaBotAhmed automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von IaBotAhmed.",
  ...
  "session.review.noVcs.createGit.description":
    "Ã„nderungen in diesem Projekt verfolgen, Ã¼berprÃ¼fen und rÃ¼ckgÃ¤ngig machen",
  ...
  "debugBar.nav.tip":
    "Letzter abgeschlossener RoutenÃ¼bergang, der eine Sitzungsseite berÃ¼hrt, gemessen vom Start des Routers bis zum ersten Rendern nach dem Einschwingen.",
  ...
  "debugBar.jank.tip": "Frames Ã¼ber 32ms in den letzten 5 Sekunden.",
  "debugBar.long.label": "LONG",
  "debugBar.long.tip": "Blockierte Zeit und Anzahl langer Aufgaben in den letzten 5 Sekunden. Max Aufgabe: {{max}}.",
  "debugBar.delay.label": "DELAY",
  "debugBar.delay.tip": "Schlechteste beobachtete EingabeverzÃ¶gerung in den letzten 5 Sekunden.",
  "debugBar.inp.label": "INP",
  "debugBar.inp.tip":
    "UngefÃ¤hre Interaktionsdauer in den letzten 5 Sekunden. Dies ist INP-Ã¤hnlich, nicht das offizielle Web Vitals INP.",
  "debugBar.cls.label": "CLS",
  "debugBar.cls.tip": "Kumulative Layoutverschiebung fÃ¼r die aktuelle App-Lebensdauer.",
  ...
  "common.key.backspace": "RÃ¼cktaste",
  ...
  "error.page.circular": "[ZirkulÃ¤r]",
  "error.serverSDK.noServerAvailable": "Kein Server verfÃ¼gbar",
  "error.serverSDK.serverNotAvailable": "Server nicht verfÃ¼gbar",
