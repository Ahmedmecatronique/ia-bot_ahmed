...
export const dict = {
  ...
  "dialog.provider.ia-bot-ahmed.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.ia-bot-ahmed.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.ia-bot-ahmedGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von ia-bot-ahmed",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in ia-bot-ahmed zu nutzen.",
  ...
  "provider.connect.ia-bot-ahmedZen.line1":
    "ia-bot-ahmed Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.ia-bot-ahmedZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.ia-bot-ahmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.ia-bot-ahmedZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in ia-bot-ahmed zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in ia-bot-ahmed zu nutzen.",
  ...
  "dialog.plugins.empty": "In ia-bot-ahmed.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den ia-bot-ahmed-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von ia-bot-ahmed ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem ia-bot-ahmed-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (ia-bot-ahmed.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: ia-bot-ahmed unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "ia-bot-ahmed enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "ia-bot-ahmed-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für ia-bot-ahmed ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie ia-bot-ahmed auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob ia-bot-ahmed dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von ia-bot-ahmed anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von ia-bot-ahmed automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von ia-bot-ahmed.",
