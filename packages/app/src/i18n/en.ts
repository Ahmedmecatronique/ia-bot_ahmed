export const dict = {
  ...
  "dialog.provider.ia-bot-ahmed.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.ia-bot-ahmed.tagline": "Reliable optimized models",
  "dialog.provider.ia-bot-ahmedGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by ia-bot-ahmed",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in ia-bot-ahmed.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.ia-bot-ahmedZen.line1":
    "ia-bot-ahmed Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.ia-bot-ahmedZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.ia-bot-ahmedZen.visit.prefix": "Visit ",
  "provider.connect.ia-bot-ahmedZen.visit.link": "ia-bot-ahmed.app/zen",
  "provider.connect.ia-bot-ahmedZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in ia-bot-ahmed.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in ia-bot-ahmed.",
  ...
  "dialog.plugins.empty": "Plugins configured in ia-bot-ahmed.json",
  ...
  "dialog.server.description": "Switch which ia-bot-ahmed server this app connects to.",
  ...
  "wsl.onboarding.step.ia-bot-ahmed": "ia-bot-ahmed",
  ...
  "wsl.onboarding.checkingia-bot-ahmed": "Checking ia-bot-ahmed...",
  "wsl.onboarding.checkingia-bot-ahmedIn": "Checking ia-bot-ahmed in {{distro}}...",
  "wsl.onboarding.updatingia-bot-ahmed": "Updating ia-bot-ahmed...",
  "wsl.onboarding.updatingia-bot-ahmedIn": "Updating ia-bot-ahmed in {{distro}}...",
  "wsl.onboarding.updateia-bot-ahmedIn": "Update ia-bot-ahmed in {{distro}}.",
  "wsl.onboarding.updateia-bot-ahmed": "Update ia-bot-ahmed",
  "wsl.onboarding.ia-bot-ahmedReadyIn": "ia-bot-ahmed is ready in {{distro}}.",
  "wsl.onboarding.ia-bot-ahmedReady": "ia-bot-ahmed is ready.",
  "wsl.onboarding.installia-bot-ahmedIn": "Install ia-bot-ahmed in {{distro}}.",
  "wsl.onboarding.installia-bot-ahmed": "Install ia-bot-ahmed",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen ia-bot-ahmed.",
  ...
  "toast.update.description": "A new version of ia-bot-ahmed ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the ia-bot-ahmed team",
  ...
  "error.chain.checkConfig": "Check your config (ia-bot-ahmed.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, ia-bot-ahmed does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "ia-bot-ahmed includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the ia-bot-ahmed server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for ia-bot-ahmed",
  ...
  "settings.general.row.appearance.description": "Customise how ia-bot-ahmed looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether ia-bot-ahmed follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how ia-bot-ahmed is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when ia-bot-ahmed launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of ia-bot-ahmed.",
