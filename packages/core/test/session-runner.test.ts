...
import {
  ...
  type LLMClientShape,
  type LLMRequest,
} from "@ia-bot-ahmed/llm"
import * as OpenAIChat from "@ia-bot-ahmed/llm/protocols/openai-chat"
import { Database } from "@ia-bot-ahmed/core/database/database"
import { EventV2 } from "@ia-bot-ahmed/core/event"
import { PermissionV2 } from "@ia-bot-ahmed/core/permission"
import { EventTable } from "@ia-bot-ahmed/core/event/sql"
import { Project } from "@ia-bot-ahmed/core/project"
import { ProjectTable } from "@ia-bot-ahmed/core/project/sql"
import { QuestionV2 } from "@ia-bot-ahmed/core/question"
import { AbsolutePath } from "@ia-bot-ahmed/core/schema"
import { SessionV2 } from "@ia-bot-ahmed/core/session"
import { ContextSnapshotDecodeError } from "@ia-bot-ahmed/core/session/error"
import { SessionEvent } from "@ia-bot-ahmed/core/session/event"
import { SessionInput } from "@ia-bot-ahmed/core/session/input"
import { SessionMessage } from "@ia-bot-ahmed/core/session/message"
import { Prompt } from "@ia-bot-ahmed/core/session/prompt"
import { SessionProjector } from "@ia-bot-ahmed/core/session/projector"
import { SessionExecution } from "@ia-bot-ahmed/core/session/execution"
import { SessionContextEpoch } from "@ia-bot-ahmed/core/session/context-epoch"
import { SessionRunCoordinator } from "@ia-bot-ahmed/core/session/run-coordinator"
import { SessionRunner } from "@ia-bot-ahmed/core/session/runner"
import * as SessionRunnerLLM from "@ia-bot-ahmed/core/session/runner/llm"
import { SessionRunnerModel } from "@ia-bot-ahmed/core/session/runner/model"
import { ToolRegistry } from "@ia-bot-ahmed/core/tool/registry"
import { ToolOutputStore } from "@ia-bot-ahmed/core/tool-output-store"
import { ApplicationTools } from "@ia-bot-ahmed/core/tool/application-tools"
import { AgentV2 } from "@ia-bot-ahmed/core/agent"
import { Config } from "@ia-bot-ahmed/core/config"
import { ConfigCompaction } from "@ia-bot-ahmed/core/config/compaction"
import { Tool } from "@ia-bot-ahmed/core/tool/tool"
import {
  SessionContextEpochTable,
  SessionInputTable,
  SessionMessageTable,
  SessionTable,
} from "@ia-bot-ahmed/core/session/sql"
import { SessionStore } from "@ia-bot-ahmed/core/session/store"
import { SystemContext } from "@ia-bot-ahmed/core/system-context"
import { SystemContextRegistry } from "@ia-bot-ahmed/core/system-context/registry"
import { SkillGuidance } from "@ia-bot-ahmed/core/skill/guidance"
import { ReferenceGuidance } from "@ia-bot-ahmed/core/reference/guidance"
