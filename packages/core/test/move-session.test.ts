...
import { MoveSession } from "@ia-bot-ahmed/core/control-plane/move-session"
import { Database } from "@ia-bot-ahmed/core/database/database"
import { FSUtil } from "@ia-bot-ahmed/core/fs-util"
import { Git } from "@ia-bot-ahmed/core/git"
...
async function initRepo(directory: string) {
  ...
  await $`git config user.email test@ia-bot-ahmed.test`.cwd(directory).quiet()
