...
declare const IA_BOT_AHMED_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof IA_BOT_AHMED_LIBC === "undefined" ? undefined : IA_BOT_AHMED_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.IA_BOT_AHMED_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.IA_BOT_AHMED_EXPERIMENTAL_FILEWATCHER) {
