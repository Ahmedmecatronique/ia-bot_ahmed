...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/v2/FileSystem/Search") {}
...
export const locationLayer = Layer.unwrap(
  Effect.sync(() => (Flag.IA_BOT_AHMED_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
