...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@ia-bot-ahmed/llm"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/v2/ToolRegistry") {}
