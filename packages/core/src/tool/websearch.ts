...
import { ToolFailure } from "@ia-bot-ahmed/llm"
...
export class ConfigService extends Context.Service<ConfigService, Config>()("@ia-bot-ahmed/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.IA_BOT_AHMED_WEBSEARCH_PROVIDER === "exa" || process.env.IA_BOT_AHMED_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.IA_BOT_AHMED_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("IA_BOT_AHMED_EXPERIMENTAL") || truthy("IA_BOT_AHMED_ENABLE_EXA") || truthy("IA_BOT_AHMED_EXPERIMENTAL_EXA"),
    enableParallel: truthy("IA_BOT_AHMED_ENABLE_PARALLEL") || truthy("IA_BOT_AHMED_EXPERIMENTAL_PARALLEL"),
              ...
              const text =
                provider === "exa"
                  ...
                  : yield* callMcp(
                      ...
                      {
                        "User-Agent": `ia-bot-ahmed/${InstallationVersion}`,
