...
import type { EffectDrizzleSqlite } from "@ia-bot-ahmed/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/ProjectDirectories") {}
