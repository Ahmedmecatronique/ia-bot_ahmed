...
import type { Plugin as PublicPlugin } from "@ia-bot-ahmed/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@ia-bot-ahmed/v2/PluginBoot") {}
