...
- Effect plugins import `@ia-bot-ahmed/plugin/v2/effect`, not `@ia-bot-ahmed/core`.
- Public domain values use generated `@ia-bot-ahmed/sdk` types.
...
- Define `PluginHost` domain capabilities in `@ia-bot-ahmed/plugin/v2/effect`.
