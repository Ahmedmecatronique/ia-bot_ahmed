...
declare const IA_BOT_AHMED_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof IA_BOT_AHMED_CLI_NAME === "string" ? IA_BOT_AHMED_CLI_NAME : "ia-bot-ahmed", {
  description: "ia-bot-ahmed 2.0 preview command line interface",
  commands: [
    Spec.make("debug", {
