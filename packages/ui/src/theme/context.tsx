...
const STORAGE_KEYS = {
  THEME_ID: "ia-bot-ahmed-theme-id",
  COLOR_SCHEME: "ia-bot-ahmed-color-scheme",
  THEME_CSS_LIGHT: "ia-bot-ahmed-theme-css-light",
  THEME_CSS_DARK: "ia-bot-ahmed-theme-css-dark",
} as const
