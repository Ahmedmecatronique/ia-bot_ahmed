...
export const dict = {
  "ui.sessionReview.title": "SitzungsÃ¤nderungen",
  "ui.sessionReview.title.lastTurn": "Ã„nderungen der letzten Runde",
  "ui.sessionReview.diffStyle.unified": "Vereinheitlicht",
  "ui.sessionReview.diffStyle.split": "Geteilt",
  "ui.sessionReview.openFile": "Datei Ã¶ffnen",
  ...
  "ui.sessionReview.change.added": "HinzugefÃ¼gt",
  "ui.sessionReview.change.removed": "Entfernt",
  "ui.sessionReview.change.modified": "GeÃ¤ndert",
  "ui.sessionReview.image.loading": "Wird geladen...",
  "ui.sessionReview.image.placeholder": "Bild",
  "ui.sessionReview.largeDiff.title": "Diff zu groÃŸ zum Rendern",
  "ui.sessionReview.largeDiff.meta": "Limit: {{limit}} geÃ¤nderte Zeilen. Aktuell: {{current}} geÃ¤nderte Zeilen.",
  ...
  "ui.fileMedia.state.unavailable": "{{kind}} nicht verfÃ¼gbar",
  "ui.fileMedia.binary.title": "BinÃ¤rdatei",
  "ui.fileMedia.binary.description.path":
    "{{path}} kann nicht angezeigt werden, da es sich um eine BinÃ¤rdatei handelt.",
  "ui.fileMedia.binary.description.default":
    "Diese Datei kann nicht angezeigt werden, da es sich um eine BinÃ¤rdatei handelt.",
  "ui.lineComment.label.prefix": "Kommentar zu ",
  "ui.lineComment.label.suffix": "",
  "ui.lineComment.editorLabel.prefix": "Kommentiere ",
  "ui.lineComment.editorLabel.suffix": "",
  "ui.lineComment.placeholder": "Kommentar hinzufÃ¼gen",
  ...
  "ui.sessionTurn.diff.showMore": "Weitere Ã„nderungen anzeigen ({{count}})",
  ...
  "ui.sessionTurn.retry.geminiHot": "gemini ist gerade sehr Ã¼berlastet",
  "ui.sessionTurn.error.freeUsageExceeded": "Kostenloses Nutzungslimit Ã¼berschritten",
  "ui.sessionTurn.error.addCredits": "Guthaben aufladen",

  "dialog.usageExceeded.freeTier.title": "Kostenloses Limit erreicht",
  "dialog.usageExceeded.freeTier.description":
    "Abonniere IaBotAhmed Go fÃ¼r zuverlÃ¤ssigen Zugriff auf die besten Open-Source-Modelle, ab $5/Monat.",
  ...
  "dialog.usageExceeded.accountRateLimit.description":
    "Nutzungslimit erreicht. Um dieses Modell jetzt weiter zu nutzen, aktiviere die Nutzung Ã¼ber dein verfÃ¼gbares Guthaben",
  "dialog.usageExceeded.accountRateLimit.actionLabel": "Einstellungen Ã¶ffnen",

  "ui.sessionTurn.status.delegating": "Arbeit delegieren",
  "ui.sessionTurn.status.planning": "NÃ¤chste Schritte planen",
  ...
  "ui.sessionTurn.status.makingEdits": "Ã„nderungen vornehmen",
  "ui.sessionTurn.status.runningCommands": "Befehle ausfÃ¼hren",
  ...
  "ui.sessionTurn.status.consideringNextSteps": "NÃ¤chste Schritte erwÃ¤gen",
  ...
  "ui.messagePart.context.read.other": "{{count}} LesevorgÃ¤nge",
  ...
  "ui.messagePart.review.title": "Antworten Ã¼berprÃ¼fen",

  "ui.list.loading": "Laden",
  "ui.list.empty": "Keine Ergebnisse",
  "ui.list.clearFilter": "Filter lÃ¶schen",
  "ui.list.emptyWithFilter.prefix": "Keine Ergebnisse fÃ¼r",
  ...
  "ui.common.add": "HinzufÃ¼gen",
  "ui.common.back": "ZurÃ¼ck",
  "ui.common.cancel": "Abbrechen",
  "ui.common.confirm": "BestÃ¤tigen",
  "ui.common.dismiss": "Verwerfen",
  "ui.common.close": "SchlieÃŸen",
  ...
  "ui.message.revertMessage": "Auf diesen Punkt zurÃ¼cksetzen",
  ...
  "ui.patch.action.deleted": "GelÃ¶scht",
  ...
  "ui.question.multiHint": "Alle zutreffenden auswÃ¤hlen",
  "ui.question.singleHint": "Eine Antwort auswÃ¤hlen",
  ...
  "ui.fileSearch.nextMatch": "NÃ¤chstes Ergebnis",
  "ui.fileSearch.close": "Suche schlieÃŸen",
  "ui.tool.task": "Aufgabe",
  "ui.tool.skill": "FÃ¤higkeit",
