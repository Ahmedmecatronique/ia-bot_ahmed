...
brew install anomalyco/tap/ia-bot-ahmed # macOS 和 Linux（推荐，始终保持最新）
brew install ia-bot-ahmed              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S ia-bot-ahmed            # Arch Linux (Stable)
paru -S ia-bot-ahmed-bin               # Arch Linux (Latest from AUR)
mise use -g ia-bot-ahmed               # 任意系统
nix run nixpkgs#ia-bot-ahmed           # 或用 github:anomalyco/ia-bot-ahmed 获取最新 dev 分支
```
...
ia-bot-ahmed 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/anomalyco/ia-bot-ahmed/releases) 或 [ia-bot-ahmed.app/download](https://ia-bot-ahmed.app/download) 下载。
...
1. `$IA_BOT_AHMED_INSTALL_DIR` - 自定义安装目录
2. `$XDG_BIN_DIR` - 符合 XDG 基础目录规范的路径
3. `$HOME/bin` - 如果存在或可创建的用户二进制目录
4. `$HOME/.ia-bot-ahmed/bin` - 默认备用路径
...
ia-bot-ahmed 内置两种 Agent，可用 `Tab` 键快速切换：
...
了解更多 [Agents](https://ia-bot-ahmed.app/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://ia-bot-ahmed.app/docs)。

### 参与贡献

如有兴趣贡献代码，请在提交 PR 前阅读 [贡献指南 (Contributing Docs)](./CONTRIBUTING.md)。

### 基于 ia-bot-ahmed 进行开发

如果你在项目名中使用了 “ia-bot-ahmed”（如 “ia-bot-ahmed-dashboard” 或 “ia-bot-ahmed-mobile”），请在 README 里注明该项目不是 ia-bot-ahmed 团队官方开发，且不存在隶属关系。

---

**加入我们的社区** [飞书](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=738j8655-cd59-4633-a30a-1124e0096789&qr_code=true) | [X.com](https://x.com/ia-bot-ahmed)
