...
- PR #15835: https://github.com/anomalyco/ia-bot-ahmed/pull/15835

## Do Not Translate (Locale Additions)

- `ia-bot-ahmed` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `ia-bot-ahmed` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `ia-bot-ahmed` in prose, `ia-bot-ahmed` only for exact technical identifiers
...
- Avoid changing `ia-bot-ahmed` to `ia-bot-ahmed` inside commands, URLs, package names, or code literals
