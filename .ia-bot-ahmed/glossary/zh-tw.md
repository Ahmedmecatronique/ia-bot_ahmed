...
- PR #13942: https://github.com/anomalyco/ia-bot-ahmed/pull/13942

## Do Not Translate (Locale Additions)

- `ia-bot-ahmed` (preserve casing in prose; keep `ia-bot-ahmed` only when it is part of commands, package names, paths, or code)
- `ia-bot-ahmed Zen`
- `ia-bot-ahmed CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `ia-bot-ahmed` in prose when referring to the product name; use `ia-bot-ahmed`
