...
Use this folder for locale-specific translation guidance that supplements `.ia-bot-ahmed/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/ia-bot-ahmed/pull/12345

## Do Not Translate (Locale Additions)

- `ia-bot-ahmed` (preserve casing)
