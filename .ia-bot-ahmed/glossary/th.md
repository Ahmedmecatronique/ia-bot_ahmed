...
- PR #10809: https://github.com/anomalyco/ia-bot-ahmed/pull/10809
- PR #11496: https://github.com/anomalyco/ia-bot-ahmed/pull/11496

## Do Not Translate (Locale Additions)

- `ia-bot-ahmed` (preserve casing in prose; keep `ia-bot-ahmed` only in commands, package names, paths, or code)
- `ia-bot-ahmed CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
