...
mode: primary
hidden: true
model: ia-bot-ahmed/gpt-5.4-mini
color: "#44BA81"
tools:
  "*": false
  "github-triage": true
...
Desktop application and browser-based app issues, including `ia-bot-ahmed web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core ia-bot-ahmed server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

ia-bot-ahmed Zen, ia-bot-ahmed Go, and billing issues.
