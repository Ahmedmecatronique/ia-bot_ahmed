...
npm i -g ia-bot-ahmed-ai@latest        # o bun/pnpm/yarn
scoop install ia-bot-ahmed             # Windows
choco install ia-bot-ahmed             # Windows
brew install anomalyco/tap/ia-bot-ahmed # macOS y Linux (recomendado, siempre al día)
brew install ia-bot-ahmed              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S ia-bot-ahmed            # Arch Linux (Stable)
paru -S ia-bot-ahmed-bin               # Arch Linux (Latest from AUR)
mise use -g ia-bot-ahmed               # cualquier sistema
nix run nixpkgs#ia-bot-ahmed           # o github:anomalyco/ia-bot-ahmed para la rama dev más reciente
```
...
ia-bot-ahmed también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/ia-bot-ahmed/releases) o desde [ia-bot-ahmed.app/download](https://ia-bot-ahmed.app/download).
...
1. `$IA_BOT_AHMED_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.ia-bot-ahmed/bin` - Alternativa por defecto
...
ia-bot-ahmed incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://ia-bot-ahmed.app/docs/agents).

### Documentación

Para más información sobre cómo configurar ia-bot-ahmed, [**ve a nuestra documentación**](https://ia-bot-ahmed.app/docs).

### Contribuir

Si te interesa contribuir a ia-bot-ahmed, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en ia-bot-ahmed

Si estás trabajando en un proyecto basado en ia-bot-ahmed y usas "ia-bot-ahmed" como parte del nombre, por ejemplo, "ia-bot-ahmed-dashboard" u "ia-bot-ahmed-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de ia-bot-ahmed y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/ia-bot-ahmed) | [X.com](https://x.com/ia-bot-ahmed)
