...
let
  packageJson = lib.pipe ../packages/ia-bot-ahmed/package.json [
    builtins.readFile
    builtins.fromJSON
  ];
...
stdenvNoCC.mkDerivation {
  pname = "ia-bot-ahmed-node_modules";
  ...
  src = lib.fileset.toSource {
    ...
    fileset = lib.fileset.intersection (lib.fileset.fromSource (lib.sources.cleanSource ../.)) (
      lib.fileset.unions [
        ...
        ../.github/TEAM_MEMBERS # required by @ia-bot-ahmed/script
      ]
    );
  };
